...
#
# @file examples/run_llama_graph_training_demo.sh
# Prepare tiny train.bin and run llama_graph_training for a few epochs.
#
# Usage (from repo root, after building llama_graph_training):
#   ./examples/run_llama_graph_training_demo.sh
#
# Optional environment variables:
#   BUILD_DIR  CMake build directory (default: <repo>/build)
#   DATA_DIR   Where to write train.bin (default: <build>/examples/demo_data/llama)
...
DATA_DIR="${DATA_DIR:-${BUILD_DIR}/examples/demo_data/llama}"
TRAIN_BIN="${DATA_DIR}/train.bin"
LOG_FILE="${DATA_DIR}/training.log"
BIN="${BUILD_DIR}/examples/llama_graph_training"
...
demo_require_executable "${BIN}" "llama_graph_training"

echo "=== Llama graph training demo ==="
