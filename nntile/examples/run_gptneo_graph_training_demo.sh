...
#
# @file examples/run_gptneo_graph_training_demo.sh
# Prepare tiny train.bin and run gptneo_graph_training for a few epochs.
#
# Usage (from repo root, after building gptneo_graph_training):
#   ./examples/run_gptneo_graph_training_demo.sh
#
# Optional environment variables:
#   BUILD_DIR  CMake build directory (default: <repo>/build)
#   DATA_DIR   Where to write train.bin (default: <build>/examples/demo_data/gptneo)
...
DATA_DIR="${DATA_DIR:-${BUILD_DIR}/examples/demo_data/gptneo}"
TRAIN_BIN="${DATA_DIR}/train.bin"
LOG_FILE="${DATA_DIR}/training.log"
BIN="${BUILD_DIR}/examples/gptneo_graph_training"
...
demo_require_executable "${BIN}" "gptneo_graph_training"

echo "=== GPT-Neo graph training demo ==="
