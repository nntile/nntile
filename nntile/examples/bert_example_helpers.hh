 ...
 *
 * @file examples/bert_example_helpers.hh
 * Shared tiny BERT config and parameter-init helpers for C++ examples.
 *
 * @version 1.1.0
 * */
    ...
    BertParamInitScale scale = BertParamInitScale::FanInSqrt)
{
         ...
         model.parameters_recursive())
    {
        ...
        if (scale == BertParamInitScale::Uniform05)
        {
