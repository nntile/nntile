 ...
 *
 * @file nntile/src/tile_graph/sumprod_fiber.cc
...
{
    nntile::core::sumprod_fiber<T>(rt.starpu_worker_hint(), a, rt.get_tile<T>(t1), rt.get_tile<T>(t2), b, rt.get_tile<T>(d), ax, r);
}
} // namespace
