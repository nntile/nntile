...
template
void gelutanh_inplace_async<fp32_fast_tf32_t>(const Tile<fp32_fast_tf32_t> &A);

template
void gelutanh_inplace_async<fp32_fast_fp16_t>(const Tile<fp32_fast_fp16_t> &A);

template
void gelutanh_inplace_async<fp32_fast_bf16_t>(const Tile<fp32_fast_bf16_t> &A);

template
void gelutanh_inplace_async<bf16_t>(const Tile<bf16_t> &A);
...
template
void gelutanh_inplace<fp32_fast_tf32_t>(const Tile<fp32_fast_tf32_t> &A);

template
void gelutanh_inplace<fp32_fast_fp16_t>(const Tile<fp32_fast_fp16_t> &A);

template
void gelutanh_inplace<fp32_fast_bf16_t>(const Tile<fp32_fast_bf16_t> &A);

template
void gelutanh_inplace<bf16_t>(const Tile<bf16_t> &A);
