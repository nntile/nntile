 ...
 *
 * @file nntile/src/tensor_graph/hypot.cc
    ...
    TensorGraph::TensorNode *src2)
{
    ...
    {
        throw std::invalid_argument("hypot: input tensors must be non-null");
    }
    if (src1 == src2)
    {
    ...
    TensorGraph::TensorNode *dst)
{
    ...
    auto op = std::make_shared<TensorHypotOp>(alpha, beta, src1, src2, dst);
