 ...
 *
 * @file nntile/tests/tile_graph/norm_slice_inplace.cc
 * Test TileGraph norm slice inplace vs nntile::core (parity).
 *
 * @version 1.1.0
 * */
...
{
    const std::vector<Index> t1h = {5, 4, 3}, t2h = {4, 3};
    const Index n1 = 60, n2 = 12;
