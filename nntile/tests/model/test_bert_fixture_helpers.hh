 ...
 *
 * @file nntile/tests/model/test_bert_fixture_helpers.hh
...
namespace nntile::test::bert_fixture
{
...
inline bool load_token_type_ids(nntile::NNGraph &g,
    const nntile::io::SafeTensorsReader &reader,
    Index n_seq,
    Index n_batch,
    nntile::NNGraph::TensorNode *&out_tt,
