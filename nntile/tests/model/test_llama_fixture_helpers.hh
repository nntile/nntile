 ...
 *
 * @file nntile/tests/model/test_llama_fixture_helpers.hh
...
//! Optional RoPE tensors from safetensors (same layout as Python
//! LlamaAttention).
...
inline bool load_llama_rope_inputs(nntile::NNGraph &g,
...
inline void bind_rope_inputs(
    nntile::Runtime &runtime, const LlamaRopeInputs &rope)
{
    if (rope.sin == nullptr)
    {
        return;
