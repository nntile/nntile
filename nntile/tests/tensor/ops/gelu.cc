 ...
 *
 * @file nntile/tests/tensor_graph/gelu.cc
 * Test TensorGraph gelu operation.
 *
 * @version 1.1.0
 * */
...
TEST_CASE("TensorGraph gelu structure", "[graph][tensor]")
{
    ...
    nntile::TensorRef dst = nntile::TensorRef::adopt(gt::gelu(src));
    ...
    "[graph][tensor]")
{
    ...
    src_node->set_name("src");
        nntile::TensorRef dst_node = nntile::TensorRef::adopt(gt::gelu(src_node));
