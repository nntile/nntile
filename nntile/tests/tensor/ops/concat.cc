 ...
 *
 * @file nntile/tests/tensor_graph/concat.cc
...
//! Reference concat in C-order dense layout (same as bind_data / get_output).
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph concat matches dense reference (untiled)",
    "[graph][tensor]")
{
    using ShapesAxis =
