 ...
 *
 * @file nntile/tests/tensor_graph/gelutanh_inplace.cc
 * Test TensorGraph gelutanh_inplace operation against
 * nntile::tensor::gelutanh_inplace.
 *
 * @version 1.1.0
 * */
...
void check_gelutanh_inplace_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::tensor::gelutanh_inplace<T>(dst);
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph gelutanh_inplace matches nntile::tensor::gelutanh_inplace",
    "[graph][tensor]")
{
