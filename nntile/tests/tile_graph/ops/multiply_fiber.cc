 ...
 *
 * @file nntile/tests/tile_graph/multiply_fiber.cc
 * Test TileGraph multiply fiber vs nntile::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::test::ContextFixture, "TileGraph multiply_fiber matches tile", "[graph][tile]")
{
    ...
    nntile::tile::multiply_fiber<fp32_t>(alpha, t1, t2, dst, axis);
