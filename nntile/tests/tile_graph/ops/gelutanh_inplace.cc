 ...
 *
 * @file nntile/tests/tile_graph/gelutanh_inplace.cc
 * TileGraph gelutanh_inplace vs nntile::tile::gelutanh_inplace (in-place parity B).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::test::ContextFixture, "TileGraph gelutanh_inplace matches tile", "[graph][tile]")
{
    ...
    nntile::tile::gelutanh_inplace<fp32_t>(td);
