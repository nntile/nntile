...
#
# @file wrappers/python/tests/model/test_bert_selfoutput.py
# Test for nntile.model.bert_modules.bert_prediction_head_transform
...
from nntile.model.bert_modules import BertPredictionHeadTransform
...
def generate_inputs(params: BertTestParams,
    ...
    torch_model = BertPredictionHeadTransform_torch(torch_config)
