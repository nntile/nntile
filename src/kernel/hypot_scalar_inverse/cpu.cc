...
template<typename T>
void cpu(Index nelems, scal_t eps_, scal_t alpha_, T* dst_)
    noexcept
...
template
void cpu<fp32_t>(Index nelems, scal_t eps, scal_t alpha, fp32_t* dst)
    noexcept;

template
void cpu<fp64_t>(Index nelems, scal_t eps, scal_t alpha, fp64_t* dst)
    noexcept;
