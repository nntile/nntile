...
void cpu<bf16_t>(Index src_m, Index src_n, Index in_channels, Index batch,
        ...
        const bf16_t *kernel, Index dst_m, Index dst_n, Scalar beta,
        bf16_t *dst) noexcept;
...
void cpu<fp32_fast_tf32_t>(Index src_m, Index src_n, Index in_channels,
        ...
        Index out_channels, const fp32_fast_tf32_t *kernel, Index dst_m,
        Index dst_n, Scalar beta, fp32_fast_tf32_t *dst) noexcept;
