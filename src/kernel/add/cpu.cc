...
template
void cpu<fp32_t>(Index num_elements, fp32_t alpha, const fp32_t* src, fp32_t beta, fp32_t* dst)
    noexcept;

template
void cpu<fp64_t>(Index num_elements, fp64_t alpha, const fp64_t* src, fp64_t beta, fp64_t* dst)
    noexcept;
