    ...
    noexcept
{
    ...
    kernel::conv2d_bwd_weight_inplace::cpu<T>(args->src1_m, args->src1_n,
            ...
            args->src2_channels, args->offset_m, args->offset_n, args->alpha,
    ...
    noexcept
{
    ...
    // Launch kernel
    kernel::conv2d_bwd_weight_inplace::cuda<T>(stream, args->src1_m, args->src1_n,
            args->src1_channels, args->batch, args->src2_m, args->src2_n,
            args->src2_channels, args->offset_m, args->offset_n, args->alpha,
            src1, src2, args->dst_m, args->dst_n, args->beta, dst);
#endif // STARPU_SIMGRID
...
void init()
{
    ...
    codelet_fp32_fast_tf32.init("nntile_conv2d_bwd_weight_inplace_fp32_fast_tf32",
            footprint,
 ...
 * */
{
    ...
    if(ret != 0)
    {
        throw std::runtime_error("Error in conv2d_bwd_weight_inplace task submission");
    }
}
