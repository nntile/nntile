...
void init()
{
    ...
    codelet_bf16.init("nntile_sum_fiber_bf16",
            footprint,
            {cpu<bf16_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<bf16_t>}
    ...
    codelet_fp32_fast_tf32.init("nntile_sum_fiber_fp32_fast_tf32",
            footprint,
            {cpu<fp32_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<fp32_t>}
    ...
    codelet_fp32_fast_bf16.init("nntile_sum_fiber_fp32_fast_bf16",
            footprint,
            {cpu<fp32_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<fp32_t>}
...
template
void submit<fp32_fast_bf16_t>(Index m, Index n, Index k, Index batch, Scalar alpha,
        Handle src, Scalar beta, Handle dst, int redux);
