...
//! StarPU wrappers for conv2d_inplace operation
namespace nntile::starpu::conv2d_inplace
{

//! StarPU wrapper for kernel::conv2d_inplace::cpu<T>
template <typename T>
    ...
    noexcept
{
    ...
    kernel::conv2d_inplace::cpu<T>(args->src1_m, args->src1_n,
            ...
            args->dilation_m, args->dilation_n, args->dst_channels,
            args->offset_m, args->offset_n, args->alpha, src1, src2,
            args->dst_m, args->dst_n, args->stride_m, args->stride_n,
            args->beta, dst);
#endif // STARPU_SIMGRID
}

#ifdef NNTILE_USE_CUDA
//! StarPU wrapper for kernel::conv2d_inplace::cuda<T>
template <typename T>
...
void init()
{
    codelet_bf16.init("nntile_conv2d_inplace_bf16",
            footprint,
            {cpu<bf16_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<bf16_t>}
    ...
    codelet_fp32.init("nntile_conv2d_inplace_fp32",
            footprint,
            {cpu<fp32_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<fp32_t>}
    ...
    codelet_fp32_fast_tf32.init("nntile_conv2d_inplace_fp32_fast_tf32",
            footprint,
    ...
    codelet_fp64.init("nntile_conv2d_inplace_fp64",
            footprint,
            {cpu<fp64_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<fp64_t>}
...
void submit<bf16_t>(Index src1_m, Index src1_n, Index src1_channels,
        ...
        Index stride_m, Index stride_n, Scalar beta, Handle dst);
