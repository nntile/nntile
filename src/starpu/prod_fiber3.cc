...
void init()
{
    ...
    codelet_bf16.init("nntile_prod_fiber3_bf16",
            footprint,
            {cpu<bf16_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<bf16_t>}
    ...
    codelet_fp32_fast_tf32.init("nntile_prod_fiber3_fp32_fast_tf32",
            footprint,
            {cpu<fp32_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<fp32_t>}
    ...
    codelet_fp32_fast_bf16.init("nntile_prod_fiber3_fp32_fast_bf16",
            footprint,
            {cpu<fp32_t>},
#ifdef NNTILE_USE_CUDA
            {cuda<fp32_t>}
...
template
void submit<fp32_fast_bf16_t>(Index m, Index n, Index k, Scalar alpha,
        Handle src1, Handle src2, Handle dst);
