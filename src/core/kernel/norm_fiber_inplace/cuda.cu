 ...
 *
 * @file src/kernel/norm_fiber_inplace/cuda.cu
 * Sums over slices into a fiber of a buffer on CUDA
 *
 * @version 1.1.0
 * */

#include "nntile/core/kernel/norm_fiber_inplace/cuda.hh"
#include <cmath>
#include <algorithm>
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::norm_fiber_inplace
{
