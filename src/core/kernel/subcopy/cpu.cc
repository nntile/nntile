...
#include "nntile/core/kernel/subcopy/cpu.hh"
#include "nntile/core/kernel/cpu.hh"

namespace nntile::core::kernel::subcopy
{
...
void cpu<int64_t>(Index ndim, const Index *src_start, const Index *src_stride,
        const Index *copy_shape, const nntile::core::int64_t *src, const Index *dst_start,
        const Index *dst_stride, nntile::core::int64_t *dst, int64_t *tmp_index)
    noexcept;
