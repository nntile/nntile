 ...
 *
 * @file src/kernel/gelu_inplace/cuda.cu
 * GeLU inplace operation on a buffer on CUDA
 *
 * @version 1.1.0
 * */

#include "nntile/core/kernel/gelu_inplace/cuda.hh"
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::gelu_inplace
{
 ...
 * nntile::core::kernel::cpu::gelutanh(). Does the following per-element operation:
