...
#include "nntile/core/kernel/add_slice_inplace/cuda.hh"
#include <algorithm>
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::add_slice_inplace
{
...
/*! @copydoc nntile::core::kernel::add_slice_inplace::cuda
 * */
{
 ...
 * use nntile::core::kernel::scale_inplace instead, and in a case of beta being zero,
 * use nntile::core::kernel::scale_slice instead.
 * If both alpha and beta are zero, then use nntile::core::kernel::clear instead.
 *
 * @see nntile::core::kernel::scale_inplace
 * @see nntile::core::kernel::scale_slice
 * @see nntile::core::kernel::clear
 *
