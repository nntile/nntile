...
#include "nntile/core/kernel/add_inplace/cuda.hh"
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::add_inplace
{
...
/*! @copydoc nntile::core::kernel::add_inplace::cuda
 * */
{
 ...
 * use nntile::core::kernel::scale instead.
