...
#include "nntile/core/kernel/add_fiber/cuda.hh"
#include <algorithm>
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::add_fiber
{
...
/*! @copydoc nntile::core::kernel::add_fiber::cuda
 * */
{
 ...
 * use nntile::core::kernel::scale, and in a case of beta being zero,
