...
#include "nntile/core/kernel/sumprod_slice/cuda.hh"
#include <algorithm>
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::sumprod_slice
{
...
void cuda<fp16_t>(cudaStream_t stream, Index m, Index n, Index k, Scalar alpha,
        const fp16_t *src1, const fp16_t *src2, Scalar beta, fp16_t *sum_dst)
    noexcept;
