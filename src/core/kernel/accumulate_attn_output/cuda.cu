...
#include "nntile/core/kernel/accumulate_attn_output/cuda.hh"
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::accumulate_attn_output
{
...
//! Accumulate attention outputs on CUDA
/*! @copydoc nntile::core::kernel::accumulate_attn_output::cuda
 * */
{
...
void cuda(cudaStream_t stream, Index head, Index seq, Index batch,
    ...
    noexcept
//! Accumulate attention outputs on CUDA
/*! @copydoc nntile::core::kernel::accumulate_attn_output::cpu
 * */
{
