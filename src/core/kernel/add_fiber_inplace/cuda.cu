...
#include "nntile/core/kernel/add_fiber_inplace/cuda.hh"
#include <algorithm>
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::add_fiber_inplace
{
...
/*! @copydoc nntile::core::kernel::add_fiber_inplace::cuda
 * */
{
 ...
 * use nntile::core::kernel::scale_inplace, and in a case of beta being zero,
 * use nntile::core::kernel::scale_fiber instead.
 * If both alpha and beta are zero, then use nntile::core::kernel::clear instead.
 *
 * @see nntile::core::kernel::scale_inplace
 * @see nntile::core::kernel::scale_fiber
