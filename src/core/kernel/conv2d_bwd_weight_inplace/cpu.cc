...
#include "nntile/core/kernel/conv2d_bwd_weight_inplace/cpu.hh"
#include <algorithm>

namespace nntile::core::kernel::conv2d_bwd_weight_inplace
{
...
template
void cpu<fp32_fast_fp16_t>(Index src1_m, Index src1_n, Index src1_channels,
        Index batch, Index src2_m, Index src2_n, Index stride_m,
        Index stride_n, Index src2_channels, Index offset_m, Index offset_n,
        Scalar alpha, const fp32_fast_fp16_t *src1,
        const fp32_fast_fp16_t *src2, Index dst_m, Index dst_n,
        Index dilation_m, Index dilation_n, Scalar beta, fp32_fast_fp16_t *dst)
    noexcept;

template
void cpu<fp32_fast_bf16_t>(Index src1_m, Index src1_n, Index src1_channels,
        Index batch, Index src2_m, Index src2_n, Index stride_m,
        Index stride_n, Index src2_channels, Index offset_m, Index offset_n,
        Scalar alpha, const fp32_fast_bf16_t *src1,
        const fp32_fast_bf16_t *src2, Index dst_m, Index dst_n,
        Index dilation_m, Index dilation_n, Scalar beta, fp32_fast_bf16_t *dst)
    noexcept;
