...
#include "nntile/core/kernel/hypot_inplace/cuda.hh"
#include "nntile/core/kernel/cuda.hh"

namespace nntile::core::kernel::hypot_inplace
{
...
/*! @copydoc nntile::core::kernel::hypot_inplace::cuda
 * */
{
 ...
 * use nntile::core::kernel::scale_inplace instead, and in a case of beta being
 * zero, use nntile::core::kernel::scale instead.
 * If both alpha and beta are zero, then use nntile::core::kernel::clear instead.
 *
 * @see nntile::core::kernel::scale_inplace
 * @see nntile::core::kernel::scale
