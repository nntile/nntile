...
template<>
void SumSlice<std::tuple<fp32_fast_tf32_t>>::cuda(void *buffers[], void *cl_args)
    noexcept
{
    // Fall back to FP32
...
template<>
void SumSlice<std::tuple<fp32_fast_fp16_t>>::cuda(void *buffers[], void *cl_args)
    noexcept
{
    // Fall back to FP32
    SumSlice<std::tuple<fp32_t>>::cuda(buffers, cl_args);
...
template<>
void SumSlice<std::tuple<fp32_fast_bf16_t>>::cuda(void *buffers[], void *cl_args)
    noexcept
{
    // Fall back to FP32
    SumSlice<std::tuple<fp32_t>>::cuda(buffers, cl_args);
...
template class SumSlice<std::tuple<nntile::core::fp64_t>>;
template class SumSlice<std::tuple<nntile::core::fp32_t>>;
template class SumSlice<std::tuple<nntile::core::fp32_fast_tf32_t>>;
template class SumSlice<std::tuple<nntile::core::fp32_fast_fp16_t>>;
template class SumSlice<std::tuple<nntile::core::fp32_fast_bf16_t>>;
template class SumSlice<std::tuple<nntile::core::bf16_t>>;
template class SumSlice<std::tuple<nntile::core::fp16_t>>;
