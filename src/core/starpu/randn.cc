    ...
    noexcept
{
    ...
    nntile::core::int64_t *tmp_index = interfaces[1]->get_ptr<nntile::core::int64_t>();
    // Launch kernel
    kernel::randn::cpu<T>(
        ndim,
        *nelems_ptr,
...
template class Randn<std::tuple<nntile::core::fp64_t>>;
template class Randn<std::tuple<nntile::core::fp32_t>>;
template class Randn<std::tuple<nntile::core::fp32_fast_tf32_t>>;
template class Randn<std::tuple<nntile::core::fp32_fast_fp16_t>>;
template class Randn<std::tuple<nntile::core::fp32_fast_bf16_t>>;
template class Randn<std::tuple<nntile::core::bf16_t>>;
