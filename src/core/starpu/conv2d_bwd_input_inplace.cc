...
Conv2dBwdInputInplace<std::tuple<T>>::Conv2dBwdInputInplace():
    codelet("nntile_conv2d_bwd_input_inplace", footprint, cpu_funcs, cuda_funcs)
{
...
template<typename T>
uint32_t Conv2dBwdInputInplace<std::tuple<T>>::footprint(struct starpu_task *task)
{
    // Get arguments
...
template class Conv2dBwdInputInplace<std::tuple<nntile::core::fp64_t>>;
template class Conv2dBwdInputInplace<std::tuple<nntile::core::fp32_t>>;
template class Conv2dBwdInputInplace<std::tuple<nntile::core::fp32_fast_tf32_t>>;
template class Conv2dBwdInputInplace<std::tuple<nntile::core::fp32_fast_fp16_t>>;
template class Conv2dBwdInputInplace<std::tuple<nntile::core::fp32_fast_bf16_t>>;
template class Conv2dBwdInputInplace<std::tuple<nntile::core::bf16_t>>;
