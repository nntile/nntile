...
template class Fill<std::tuple<nntile::core::fp64_t>>;
template class Fill<std::tuple<nntile::core::fp32_t>>;
template class Fill<std::tuple<nntile::core::fp32_fast_tf32_t>>;
template class Fill<std::tuple<nntile::core::fp32_fast_fp16_t>>;
template class Fill<std::tuple<nntile::core::fp32_fast_bf16_t>>;
template class Fill<std::tuple<nntile::core::bf16_t>>;
template class Fill<std::tuple<nntile::core::fp16_t>>;
