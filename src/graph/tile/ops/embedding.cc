...
{
    nntile::core::tile::embedding<T>(a, b, c, ks, kz, runtime.get_tile<nntile::core::int64_t>(ix), runtime.get_tile<T>(v), runtime.get_tile<T>(e));
}
} // namespace
void embedding(
...
void TileEmbeddingOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run<nntile::core::fp32_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::FP32_FAST_TF32:
            run<nntile::core::fp32_fast_tf32_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::FP32_FAST_FP16:
            run<nntile::core::fp32_fast_fp16_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::FP32_FAST_BF16:
            run<nntile::core::fp32_fast_bf16_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::FP64:
            run<nntile::core::fp64_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::FP16:
            run<nntile::core::fp16_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::BF16:
            run<nntile::core::bf16_t>(runtime, m, n, k, k_start, k_size, index, vocab, embed);
            break;
        case DataType::INT64:
        case DataType::BOOL:
