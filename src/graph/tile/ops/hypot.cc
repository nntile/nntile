...
{
    nntile::core::tile::hypot<T>(a, runtime.get_tile<T>(s1), b, runtime.get_tile<T>(s2), runtime.get_tile<T>(d));
}
} // namespace
void hypot(
...
void TileHypotOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run_hy<nntile::core::fp32_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::FP32_FAST_TF32:
            run_hy<nntile::core::fp32_fast_tf32_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::FP32_FAST_FP16:
            run_hy<nntile::core::fp32_fast_fp16_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::FP32_FAST_BF16:
            run_hy<nntile::core::fp32_fast_bf16_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::FP64:
            run_hy<nntile::core::fp64_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::FP16:
            run_hy<nntile::core::fp16_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::BF16:
            run_hy<nntile::core::bf16_t>(runtime, alpha, src1, beta, src2, dst);
            break;
        case DataType::INT64:
        case DataType::BOOL:
