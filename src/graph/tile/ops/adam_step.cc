...
{
    nntile::core::tile::adam_step<T>(num_iter, beta_1, beta_2, eps, lr, weight_decay,
...
void TileAdamStepOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run_adam<nntile::core::fp32_t>(runtime, num_iter, beta_1, beta_2, eps, lr,
                weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::FP32_FAST_TF32:
            run_adam<nntile::core::fp32_fast_tf32_t>(runtime, num_iter, beta_1, beta_2,
                eps, lr, weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::FP32_FAST_FP16:
            run_adam<nntile::core::fp32_fast_fp16_t>(runtime, num_iter, beta_1, beta_2,
                eps, lr, weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::FP32_FAST_BF16:
            run_adam<nntile::core::fp32_fast_bf16_t>(runtime, num_iter, beta_1, beta_2,
                eps, lr, weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::FP64:
            run_adam<nntile::core::fp64_t>(runtime, num_iter, beta_1, beta_2, eps, lr,
                weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::FP16:
            run_adam<nntile::core::fp16_t>(runtime, num_iter, beta_1, beta_2, eps, lr,
                weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::BF16:
            run_adam<nntile::core::bf16_t>(runtime, num_iter, beta_1, beta_2, eps, lr,
                weight_decay, grad, first_moment, second_moment, p);
            break;
        case DataType::INT64:
        case DataType::BOOL:
