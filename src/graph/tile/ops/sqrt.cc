...
void TileSqrtOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run_sqrt<nntile::core::fp32_t>(runtime, src, dst);
            break;
        case DataType::FP32_FAST_TF32:
            run_sqrt<nntile::core::fp32_fast_tf32_t>(runtime, src, dst);
            break;
        case DataType::FP32_FAST_FP16:
            run_sqrt<nntile::core::fp32_fast_fp16_t>(runtime, src, dst);
            break;
        case DataType::FP32_FAST_BF16:
            run_sqrt<nntile::core::fp32_fast_bf16_t>(runtime, src, dst);
            break;
        case DataType::FP64:
            run_sqrt<nntile::core::fp64_t>(runtime, src, dst);
            break;
        case DataType::FP16:
            throw std::runtime_error(
                "FP16 data type not supported for tile sqrt");
        case DataType::BF16:
            run_sqrt<nntile::core::bf16_t>(runtime, src, dst);
            break;
        case DataType::INT64:
        case DataType::BOOL:
            throw std::runtime_error(
