...
#include <nntile/core/tile/silu_inplace.hh>
...
void run_silu_inplace(Runtime& runtime, TileGraph::TileNode* d)
{
    ...
    nntile::core::tile::silu_inplace<T>(t);
}
...
void TileSiluInplaceOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run_silu_inplace<nntile::core::fp32_t>(runtime, dst);
            break;
        case DataType::FP32_FAST_TF32:
            run_silu_inplace<nntile::core::fp32_fast_tf32_t>(runtime, dst);
            break;
        case DataType::FP32_FAST_FP16:
            run_silu_inplace<nntile::core::fp32_fast_fp16_t>(runtime, dst);
            break;
        case DataType::FP32_FAST_BF16:
            run_silu_inplace<nntile::core::fp32_fast_bf16_t>(runtime, dst);
            break;
        case DataType::FP64:
            run_silu_inplace<nntile::core::fp64_t>(runtime, dst);
            break;
        case DataType::FP16:
            run_silu_inplace<nntile::core::fp16_t>(runtime, dst);
            break;
        case DataType::BF16:
            run_silu_inplace<nntile::core::bf16_t>(runtime, dst);
            break;
        case DataType::INT64:
        case DataType::BOOL:
