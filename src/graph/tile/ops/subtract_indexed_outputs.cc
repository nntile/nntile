...
{
    nntile::core::tile::subtract_indexed_outputs<T>(vl, runtime.get_tile<nntile::core::int64_t>(l), runtime.get_tile<T>(d), ig);
}
} // namespace
...
void TileSubtractIndexedOutputsOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run<nntile::core::fp32_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::FP32_FAST_TF32:
            run<nntile::core::fp32_fast_tf32_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::FP32_FAST_FP16:
            run<nntile::core::fp32_fast_fp16_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::FP32_FAST_BF16:
            run<nntile::core::fp32_fast_bf16_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::FP64:
            run<nntile::core::fp64_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::FP16:
            run<nntile::core::fp16_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::BF16:
            run<nntile::core::bf16_t>(runtime, v, labels, dst, ignore_index);
            break;
        case DataType::INT64:
        case DataType::BOOL:
