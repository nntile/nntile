    ...
    TileGraph::TileNode* dx)
{
    ...
    nntile::core::tile::gelutanh_backward<T>(x_t, dy_t, dx_t);
}
...
void TileGelutanhBackwardOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run_gelutanh_backward<nntile::core::fp32_t>(runtime, x, dy, dx);
            break;
        case DataType::FP32_FAST_TF32:
            run_gelutanh_backward<nntile::core::fp32_fast_tf32_t>(runtime, x, dy, dx);
            break;
        case DataType::FP32_FAST_FP16:
            run_gelutanh_backward<nntile::core::fp32_fast_fp16_t>(runtime, x, dy, dx);
            break;
        case DataType::FP32_FAST_BF16:
            run_gelutanh_backward<nntile::core::fp32_fast_bf16_t>(runtime, x, dy, dx);
            break;
        case DataType::FP64:
            run_gelutanh_backward<nntile::core::fp64_t>(runtime, x, dy, dx);
            break;
        case DataType::FP16:
            run_gelutanh_backward<nntile::core::fp16_t>(runtime, x, dy, dx);
            break;
        case DataType::BF16:
            run_gelutanh_backward<nntile::core::bf16_t>(runtime, x, dy, dx);
            break;
        case DataType::INT64:
        case DataType::BOOL:
