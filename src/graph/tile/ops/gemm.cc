    ...
    TileGraph::TileNode* c)
{
    ...
    const auto trans_a_op = trans_a ? nntile::core::TransOp(nntile::core::TransOp::Trans)
                                    : nntile::core::TransOp(nntile::core::TransOp::NoTrans);
    const auto trans_b_op = trans_b ? nntile::core::TransOp(nntile::core::TransOp::Trans)
                                    : nntile::core::TransOp(nntile::core::TransOp::NoTrans);

    nntile::core::tile::gemm<T>(
...
void TileGemmOp::execute(Runtime& runtime) const
{
    ...
    {
        case DataType::FP32:
            run_gemm<nntile::core::fp32_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::FP32_FAST_TF32:
            run_gemm<nntile::core::fp32_fast_tf32_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::FP32_FAST_FP16:
            run_gemm<nntile::core::fp32_fast_fp16_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::FP32_FAST_BF16:
            run_gemm<nntile::core::fp32_fast_bf16_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::FP64:
            run_gemm<nntile::core::fp64_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::FP16:
            run_gemm<nntile::core::fp16_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::BF16:
            run_gemm<nntile::core::bf16_t>(
                runtime, alpha, beta, trans_a, trans_b, ndim, batch_ndim, a,
                b, c);
            break;
        case DataType::INT64:
