 ...
 *
 * @file src/graph/compiled/conv2d_inplace.cc
 * Compiled graph conv2d_inplace operation.
 *
 * @version 1.1.0
 * */
...
void execute_conv2d_inplace(CompiledGraph& graph, const OpExecutionInfo& op_info)
{
    ...
    switch(dtype)
    {
        ...
        case DataType::FP64:
            ...
            break;
        case DataType::FP16:
            throw std::runtime_error("FP16 data type not supported for conv2d_inplace operation");
            break;
        case DataType::BF16:
