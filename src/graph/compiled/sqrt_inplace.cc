 ...
 *
 * @file src/graph/compiled/sqrt_inplace.cc
 * Compiled graph sqrt_inplace operation.
 *
 * @version 1.1.0
 * */
...
void execute_sqrt_inplace(CompiledGraph& graph, const OpExecutionInfo& op_info)
{
    ...
    switch(dtype)
    {
        ...
        case DataType::FP64:
            ...
            break;
        case DataType::FP16:
            throw std::runtime_error("FP16 data type not supported for sqrt_inplace operation");
            break;
        case DataType::BF16:
