...
template<typename T>
void run_add_fiber(CompiledGraph& graph, const ReductionAttrs& attrs,
                 ...
                 const std::string& z_name)
{
    ...
    nntile::tensor::add_fiber<T>(alpha, x, beta, y, z, attrs.axis, attrs.batch_ndim);
}
...
void execute_add_fiber(CompiledGraph& graph, const OpExecutionInfo& op_info)
{
    ...
    {
        case DataType::FP32:
            run_add_fiber<nntile::fp32_t>(graph, attrs, x_name, y_name, z_name);
            break;
        case DataType::FP32_FAST_TF32:
            run_add_fiber<nntile::fp32_fast_tf32_t>(graph, attrs, x_name, y_name, z_name);
            break;
        case DataType::FP32_FAST_FP16:
            run_add_fiber<nntile::fp32_fast_fp16_t>(graph, attrs, x_name, y_name, z_name);
            break;
        case DataType::FP32_FAST_BF16:
            run_add_fiber<nntile::fp32_fast_bf16_t>(graph, attrs, x_name, y_name, z_name);
            break;
        case DataType::FP64:
            run_add_fiber<nntile::fp64_t>(graph, attrs, x_name, y_name, z_name);
            break;
        case DataType::BF16:
            run_add_fiber<nntile::bf16_t>(graph, attrs, x_name, y_name, z_name);
            break;
        case DataType::FP16:
        case DataType::INT64:
        case DataType::INT32:
