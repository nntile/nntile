...
void execute_flash_sdpa_bwd_cudnn(CompiledGraph& graph, const OpExecutionInfo& op_info)
{
    ...
    {
        case DataType::FP32:
            throw std::runtime_error("FP32 data type not supported for flash_sdpa_bwd_cudnn operation");
            break;
        case DataType::FP32_FAST_TF32:
            throw std::runtime_error("FP32_FAST_TF32 data type not supported for flash_sdpa_bwd_cudnn operation");
            break;
        case DataType::FP32_FAST_FP16:
            throw std::runtime_error("FP32_FAST_FP16 data type not supported for flash_sdpa_bwd_cudnn operation");
            break;
        case DataType::FP32_FAST_BF16:
            throw std::runtime_error("FP32_FAST_BF16 data type not supported for flash_sdpa_bwd_cudnn operation");
            break;
        case DataType::FP64:
