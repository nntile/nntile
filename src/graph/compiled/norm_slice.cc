 ...
 *
 * @file src/graph/compiled/norm_slice.cc
 * Compiled graph norm_slice operation.
 *
 * @version 1.1.0
 * */
                    ...
                    const std::string& dst_name)
{
    ...
    nntile::tensor::norm_slice<T>(alpha, x, beta, src2, dst, attrs.axis, attrs.redux);
}
...
void execute_norm_slice(CompiledGraph& graph, const OpExecutionInfo& op_info)
{
    ...
    {
        case DataType::FP32:
            run_norm_slice<nntile::fp32_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::FP32_FAST_TF32:
            run_norm_slice<nntile::fp32_fast_tf32_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::FP32_FAST_FP16:
            run_norm_slice<nntile::fp32_fast_fp16_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::FP32_FAST_BF16:
            run_norm_slice<nntile::fp32_fast_bf16_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::FP64:
            run_norm_slice<nntile::fp64_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::FP16:
            run_norm_slice<nntile::fp16_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::BF16:
            run_norm_slice<nntile::bf16_t>(graph, attrs, x_name, src2_name, dst_name);
            break;
        case DataType::INT64:
        case DataType::INT32:
        case DataType::BOOL:
