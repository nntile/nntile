    ...
    TensorGraph::ExecutionContext& ctx) const
{
    ...
    {
        case DataType::FP32:
            run_silu<nntile::fp32_t>(ctx, src, dst);
            break;
        case DataType::FP32_FAST_TF32:
            run_silu<nntile::fp32_fast_tf32_t>(ctx, src, dst);
            break;
        case DataType::FP32_FAST_FP16:
            run_silu<nntile::fp32_fast_fp16_t>(ctx, src, dst);
            break;
        case DataType::FP32_FAST_BF16:
            run_silu<nntile::fp32_fast_bf16_t>(ctx, src, dst);
            break;
        case DataType::FP64:
            run_silu<nntile::fp64_t>(ctx, src, dst);
            break;
        case DataType::FP16:
            run_silu<nntile::fp16_t>(ctx, src, dst);
            break;
        case DataType::BF16:
            run_silu<nntile::bf16_t>(ctx, src, dst);
            break;
        case DataType::INT64:
        case DataType::BOOL:
