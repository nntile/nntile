...
{
    if(K == nullptr || Q == nullptr || V == nullptr || A == nullptr || dA == nullptr ||
       mask == nullptr || logsumexp == nullptr || dK == nullptr || dQ == nullptr || dV == nullptr)
    {
        throw std::invalid_argument(
            "flash_sdpa_bwd_cudnn: input tensors must be non-null");
    }
