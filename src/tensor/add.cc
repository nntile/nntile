...
template
void add_async<fp16_t>(Scalar alpha, const Tensor<fp16_t> &src1, Scalar beta,
...
template
void add_async<fp32_fast_bf16_t>(Scalar alpha, const Tensor<fp32_fast_bf16_t> &src1,
...
template
void add<fp16_t>(Scalar alpha, const Tensor<fp16_t> &src1, Scalar beta,
        const Tensor<fp16_t> &src2, const Tensor<fp16_t> &dst);
...
template
void add<fp32_fast_bf16_t>(Scalar alpha, const Tensor<fp32_fast_bf16_t> &src1,
        Scalar beta, const Tensor<fp32_fast_bf16_t> &src2,
        const Tensor<fp32_fast_bf16_t> &dst);
