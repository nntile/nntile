 ...
 *
 * @file src/tile/conv2d_inplace.cc
...
void conv2d_inplace_async<bf16_t>(Index src1_m, Index src1_n,
        ...
        const Tile<bf16_t> &src2, Index dst_m, Index dst_n, Index stride_m,
...
void conv2d_inplace_async<fp32_t>(Index src1_m, Index src1_n,
        ...
        const Tile<fp32_t> &src2, Index dst_m, Index dst_n, Index stride_m,
...
void conv2d_inplace_async<fp32_fast_tf32_t>(Index src1_m, Index src1_n,
        ...
        Index stride_m, Index stride_n, Scalar beta,
...
void conv2d_inplace_async<fp64_t>(Index src1_m, Index src1_n,
        ...
        const Tile<fp64_t> &src2, Index dst_m, Index dst_n, Index stride_m,
        Index stride_n, Scalar beta, const Tile<fp64_t> &dst);
