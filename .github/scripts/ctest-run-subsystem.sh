...
case "$sub" in
    ...
    tile) echo 'tests_core_tile_' ;;
    tensor) echo 'tests_core_tensor_' ;;
    tile_graph) echo 'tests_graph_tile_' ;;
    tensor_graph) echo 'tests_graph_tensor_' ;;
    nn_graph) echo 'tests_graph_nn_' ;;
