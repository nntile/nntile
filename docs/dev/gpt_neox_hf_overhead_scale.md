...
3. **nntile(nntile)** —
   `torch_nntile.nn.model.gpt_neox.GPTNeoXCausal` (hand-written nntile kernels). HF is used
...
| M T=1536 | 8.167099 | 8.167099 | 8.167099 |
...
| M T=1536 | 13.6 GiB | 14.7 GiB | 5.11 GB | **0** | 17.8 GiB | 5.40 GB | **0** |
