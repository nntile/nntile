...
|-------|----------:|------------:|------------:|---------------:|--------------:|--------:|----:|-----:|----------:|----------:|------------:|
| XS T=768 | 1.430 ± 0.005 s | 1.670 ± 0.034 s | **1.17×** | 0.047 ± 0.006 s | 0.306 ± 0.022 s | 0.119 ± 0.019 s | 0.118 ± 0.021 s | 1.079 ± 0.043 s | **28.2%** | 7.890008 | **7.889859** |
...
**flat**). Host **share** drops **28.2% → 14.8% → 5.5% → 2.4% → 1.2%**
as GPU work grows.
...
XS 0.147 ± 0.001 vs 0.129 ± 0.001 s, S 0.278 ± 0.002 vs 0.259 ± 0.001 s, M 0.801 ± 0.004 vs 0.771 ± 0.001 s, L 1.828 ± 0.002 vs 1.776 ± 0.002 s, XL 2.534 ± 0.003 vs 2.468 ± 0.004 s.
...
|-----:|----------:|---------------:|--------------:|--------:|----:|-----:|
| 1 | 0.275 ± 0.004 | 0.002 | 0.020 ± 0.002 | 0.005 ± 0.002 | 0.007 ± 0.003 | 0.000 |
| 2 | 0.128 ± 0.000 | 0.002 | 0.015 ± 0.001 | 0.005 ± 0.001 | 0.007 ± 0.001 | 0.254 ± 0.011 |
| 3 | 0.128 ± 0.001 | 0.003 ± 0.001 | 0.018 ± 0.002 | 0.008 ± 0.003 | 0.009 ± 0.003 | 0.111 ± 0.005 |
| 4 | 0.128 ± 0.001 | 0.004 ± 0.001 | 0.023 ± 0.004 | 0.010 ± 0.004 | 0.011 ± 0.003 | 0.104 ± 0.010 |
| 5 | 0.128 ± 0.001 | 0.005 ± 0.001 | 0.029 ± 0.004 | 0.012 ± 0.003 | 0.013 ± 0.003 | 0.092 ± 0.008 |
| 6 | 0.128 ± 0.001 | 0.006 ± 0.001 | 0.033 ± 0.003 | 0.014 ± 0.002 | 0.014 ± 0.003 | 0.085 ± 0.007 |
| 7 | 0.129 ± 0.001 | 0.006 ± 0.001 | 0.037 ± 0.004 | 0.015 ± 0.002 | 0.013 ± 0.002 | 0.080 ± 0.006 |
| 8 | 0.129 ± 0.000 | 0.006 ± 0.000 | 0.040 ± 0.003 | 0.015 ± 0.001 | 0.015 ± 0.003 | 0.079 ± 0.006 |
| 9 | 0.129 ± 0.001 | 0.006 ± 0.001 | 0.044 ± 0.003 | 0.016 ± 0.001 | 0.015 ± 0.002 | 0.070 ± 0.003 |
| 10 | 0.129 ± 0.000 | 0.007 ± 0.001 | 0.047 ± 0.002 | 0.017 ± 0.003 | 0.014 ± 0.002 | 0.204 ± 0.005 |
...
|-------|---------------:|--------------:|--------:|----:|-----:|---------:|--------------:|
| XS | 0.007 ± 0.000 | 0.048 ± 0.002 | 0.015 ± 0.001 | 0.014 ± 0.001 | 0.133 ± 0.001 | **0.147 ± 0.001** | 0.129 ± 0.001 |
...
|-------|----------:|----------------:|-----:|--------:|-------------:|----------:|
| XS T=768 | 1.430 ± 0.005 s | 2.076 ± 0.021 s | 0.485 ± 0.019 s | **1.590 ± 0.016 s** | **1.11×** | 23.4% |
...
|-----:|-----:|--------:|---------------:|--------------:|--------:|----:|-----:|
| 1 | 0.027 ± 0.002 | 0.283 ± 0.011 | 0.002 ± 0.000 | 0.020 ± 0.001 | 0.005 ± 0.001 | 0.006 ± 0.001 | 0.277 ± 0.011 |
| 2 | 0.024 ± 0.001 | 0.143 ± 0.001 | 0.003 ± 0.001 | 0.016 ± 0.001 | 0.006 ± 0.000 | 0.006 ± 0.001 | 0.138 ± 0.001 |
| 3 | 0.032 ± 0.004 | 0.144 ± 0.001 | 0.004 ± 0.001 | 0.020 ± 0.002 | 0.008 ± 0.001 | 0.008 ± 0.002 | 0.137 ± 0.001 |
| 4 | 0.040 ± 0.004 | 0.145 ± 0.001 | 0.004 ± 0.001 | 0.025 ± 0.002 | 0.010 ± 0.002 | 0.009 ± 0.002 | 0.135 ± 0.001 |
| 5 | 0.048 ± 0.005 | 0.145 ± 0.001 | 0.006 ± 0.001 | 0.030 ± 0.002 | 0.012 ± 0.002 | 0.011 ± 0.002 | 0.134 ± 0.001 |
| 6 | 0.053 ± 0.004 | 0.146 ± 0.001 | 0.006 ± 0.001 | 0.035 ± 0.002 | 0.013 ± 0.001 | 0.012 ± 0.002 | 0.134 ± 0.002 |
| 7 | 0.060 ± 0.003 | 0.146 ± 0.001 | 0.007 ± 0.001 | 0.038 ± 0.002 | 0.014 ± 0.001 | 0.013 ± 0.001 | 0.133 ± 0.001 |
| 8 | 0.064 ± 0.002 | 0.146 ± 0.001 | 0.007 ± 0.000 | 0.042 ± 0.001 | 0.015 ± 0.001 | 0.013 ± 0.001 | 0.132 ± 0.001 |
| 9 | 0.068 ± 0.003 | 0.146 ± 0.002 | 0.008 ± 0.002 | 0.045 ± 0.002 | 0.015 ± 0.001 | 0.014 ± 0.001 | 0.133 ± 0.002 |
| 10 | 0.069 ± 0.002 | 0.146 ± 0.002 | 0.007 ± 0.001 | 0.047 ± 0.001 | 0.015 ± 0.001 | 0.014 ± 0.001 | 0.133 ± 0.001 |
...
Steady compute after iter 1 (mean over repeats): ~0.143 s (XS), ~0.274 s (S), ~0.793 s (M), ~1.831 s (L), ~2.531 s (XL).
...
3. **With VRAM headroom, nntile is within ~5–16% of CUDA on wall time**
   (XS 1.17×, S 1.12×, M 1.05×, L 1.05×, XL 1.04×).
4. **Sequential GPU time** (`run+wait`): **1.11× → 1.08× → 1.03× → 1.04× → 1.04×** CUDA.
