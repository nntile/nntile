...
#include <cstdlib>
#include <nntile/core/tensor/traits.hh>
...
public:
    ...
    void set_reduction_add() const
    {
        ...
        //     {
        //         auto tmp = tile_handles[i].get();
        //         auto accumulate_pack = nntile::core::starpu::accumulate;
        //         auto accumulate_op = static_cast<starpu::Accumulate<std::tuple<T>>>(accumulate_pack);
        //         auto clear_codelet = &nntile::core::starpu::clear.codelet;
    ...
    void set_reduction_hypot() const
    {
        ...
        //     {
        //         auto tmp = tile_handles[i].get();
        //         auto accumulate_pack = nntile::core::starpu::accumulate_hypot;
    ...
    void set_reduction_maxsumexp() const
    {
        ...
        //     {
        //         auto tmp = tile_handles[i].get();
        //         auto accumulate_pack = nntile::core::starpu::accumulate_maxsumexp;
