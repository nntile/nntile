...
//! Generic wrapper class for add_slice_inplace operation is not defined
template<typename T>
class AddSliceInplace;

//! Specialization of wrapper class for add operation via std::tuple
template<typename T>
class AddSliceInplace<std::tuple<T>>
{
public:
...
using add_slice_inplace_pack_t = OperationPack<
    AddSliceInplace,
...
//! Pack of add_slice_inplace operations for different types
extern add_slice_inplace_pack_t add_slice_inplace;
