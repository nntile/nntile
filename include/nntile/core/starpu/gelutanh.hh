...
//! Generic wrapper class for gelutanh operation is not defined
template<typename T>
class GeluTanh;

//! Specialization of wrapper class for gelutanh operation via std::tuple
template<typename T>
class GeluTanh<std::tuple<T>>
{
public:
...
using gelutanh_pack_t = OperationPack<
    GeluTanh,
