...
//! Generic wrapper class for add_fiber operation is not defined
template<typename T>
class AddFiber;

//! Specialization of wrapper class for add_fiber operation via std::tuple
template<typename T>
class AddFiber<std::tuple<T>>
{
public:
...
using add_fiber_pack_t = OperationPack<
    AddFiber,
...
//! Pack of add_fiber operations for different types
extern add_fiber_pack_t add_fiber;
