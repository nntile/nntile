 ...
 *
 * @file include/nntile/starpu/scale_slice.hh
...
//! Generic wrapper class for scale_slice operation is not defined
template<typename T>
class ScaleSlice;

//! Specialization of wrapper class for scale operation via std::tuple
template<typename T>
class ScaleSlice<std::tuple<T>>
{
public:
...
using scale_slice_pack_t = OperationPack<
    ScaleSlice,
...
//! Pack of scale_slice operations for different types
extern scale_slice_pack_t scale_slice;
