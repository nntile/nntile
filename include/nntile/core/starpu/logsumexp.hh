...
//! Generic wrapper class for logsumexp operation is not defined
template<typename T>
class LogSumExp;

//! Specialization of wrapper class for logsumexp operation via std::tuple
template<typename T>
class LogSumExp<std::tuple<T>>
{
public:
...
using logsumexp_pack_t = OperationPack<
    LogSumExp,
