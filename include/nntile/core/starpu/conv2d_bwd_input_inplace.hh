...
//! Generic wrapper class for conv2d_bwd_input_inplace operation is not defined
template<typename T>
class Conv2dBwdInputInplace;

//! Specialization of wrapper class for conv2d_bwd_input_inplace operation via std::tuple
template<typename T>
class Conv2dBwdInputInplace<std::tuple<T>>
{
public:
...
using conv2d_bwd_input_inplace_pack_t = OperationPack<
    Conv2dBwdInputInplace,
...
//! Pack of conv2d_bwd_input_inplace operations for different types
extern conv2d_bwd_input_inplace_pack_t conv2d_bwd_input_inplace;
