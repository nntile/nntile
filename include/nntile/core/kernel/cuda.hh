...
//! Compute type for nntile::core::int64_t type
template<>
struct CUDAComputeType<int64_t>
{
    // nntile::core::int64_t -> std::int64_t from <cstdint>
    using value = std::int64_t;
};

//! Compute type for nntile::core::bool_t type
template<>
struct CUDAComputeType<bool_t>
{
    // nntile::core::bool_t -> bool from C++ base
    using value = bool;
};

//! Compute type for nntile::core::fp64_t type
template<>
struct CUDAComputeType<fp64_t>
{
    // nntile::core::fp64_t -> double from C++ base
    using value = double;
};

//! Compute type for nntile::core::fp32_t type
template<>
struct CUDAComputeType<fp32_t>
{
    // nntile::core::fp32_t -> double from C++ base
    using value = float;
};

//! Compute type for nntile::core::fp32_fast_tf32_t type
template<>
...
//! Compute type for nntile::core::bf16_t type
template<>
