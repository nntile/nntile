...
//! Generic wrapper class for add_scalar operation is not defined
template<typename T>
class AddScalar;

//! Specialization of wrapper class for add_scalar operation via std::tuple
template<typename T>
class AddScalar<std::tuple<T>>
{
public:
...
using add_scalar_pack_t = OperationPack<
    AddScalar,
...
//! Pack of add_scalar operations for different types
extern add_scalar_pack_t add_scalar;
