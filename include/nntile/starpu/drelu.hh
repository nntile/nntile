 ...
 *
 * @file include/nntile/starpu/drelu.hh
...
//! Generic wrapper class for drelu operation is not defined
template<typename T>
class DRelu;

//! Specialization of wrapper class for drelu operation via std::tuple
template<typename T>
class DRelu<std::tuple<T>>
{
public:
...
using drelu_pack_t = OperationPack<
    DRelu,
