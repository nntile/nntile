 ...
 *
 * @file include/nntile/starpu/flash_attention.hh
 * Flash attention operation with StarPU buffers
 *
 * @version 1.1.0
 * */
...
//! Generic wrapper class for flash_attention operation is not defined
template<typename T>
class FlashAttention;

//! Specialization of wrapper class for flash_attention operation via std::tuple
template<typename T>
...
using flash_attention_pack_t = OperationPack<
    FlashAttention,
