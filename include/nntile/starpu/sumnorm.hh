...
//! Generic wrapper class for sumnorm operation is not defined
template<typename T>
class SumNorm;

//! Specialization of wrapper class for sumnorm operation via std::tuple
template<typename T>
class SumNorm<std::tuple<T>>
{
public:
...
using sumnorm_pack_t = OperationPack<
    SumNorm,
