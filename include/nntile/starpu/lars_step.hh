...
//! Generic wrapper class for lars_step operation is not defined
template<typename T>
class LarsStep;

//! Specialization of wrapper class for lars_step operation via std::tuple
template<typename T>
class LarsStep<std::tuple<T>>
{
public:
...
using lars_step_pack_t = OperationPack<
    LarsStep,
...
//! Pack of lars_step operations for different types
extern lars_step_pack_t lars_step;
