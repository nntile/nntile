 ...
 *
 * @file include/nntile/graph/tile/ops/silu_backward.hh
...
struct TileSiluBackwardOp : TileGraph::OpNode
{
    ...
    std::string op_name() const override { return "TILE_SILU_BACKWARD"; }

    void execute(Runtime& runtime) const override;

    std::shared_ptr<TileGraph::OpNode> clone() const override
    {
        return std::make_shared<TileSiluBackwardOp>(*this);
    }
};
