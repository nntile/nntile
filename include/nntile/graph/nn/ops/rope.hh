 ...
 *
 * @file include/nntile/graph/nn/ops/rope.hh
...
//! RoPE op: y = rope(sin, cos, x). PyTorch-style: outputs created in
//! forward(). sin and cos are positional embeddings (typically no grad); only
//! x gets grad.
...
NNGraph::TensorNode *rope(NNGraph::TensorNode *sin,
