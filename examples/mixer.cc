...
int main(int argc, char **argv)
{
    ...
    std::vector<Index> input_images_shape = {n_patch_pixels, n_patches,
        n_images};
    std::vector<Index> input_images_basetile = {n_patch_pixels, n_patches,
        n_images_tile};
    ...
    std::vector<Index> mixer_x_shape = {n_patches, n_images,
        n_channels};
    std::vector<Index> mixer_x_basetile = {n_patches, n_images_tile,
        n_channels_tile};
    ...
    std::vector<Index> mixer_mlp1_fc1_shape = {n_mlp_S, n_patches},
        ...
        mixer_mlp1_fc2_basetile = {n_patches, n_mlp_S_tile};
    ...
    std::vector<Index> mixer_x_mlp2_gelu_shape = {n_patches, n_images,
        n_mlp_C};
    std::vector<Index> mixer_x_mlp2_gelu_basetile = {n_patches, n_images_tile,
        n_mlp_C_tile};
    ...
    Tensor<T> sum_ssq1({3, n_patches, n_images},
            {3, n_patches, n_images_tile}),
        avg_dev1({2, n_patches, n_images},
                {2, n_patches, n_images_tile});
