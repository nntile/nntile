 ...
 *
 * @file tests/graph/tile/sqrt.cc
 * sqrt: TensorGraph vs TileGraph (mixed tile sizes) parity.
 *
 * @version 1.1.0
 * */
...
TEST_CASE("sqrt mixed tile parity", "[graph][tile]")
{
    ...
    TensorGraph::TensorNode* s_ref = gt::sqrt(x_ref, "s");
    ...
    TensorGraph::TensorNode* s_tile = gt::sqrt(x_tile, "s");
