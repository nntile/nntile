 ...
 *
 * @file tests/graph/tile/relu_backward.cc
 * Test TileGraph relu backward vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph relu_backward matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::relu_backward<fp32_t>(tx, tdy, tdx);
