 ...
 * Test TileGraph gelutanh backward vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph gelutanh_backward matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::gelutanh_backward<fp32_t>(tx, tdy, tdx);
