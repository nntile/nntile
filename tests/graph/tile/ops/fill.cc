 ...
 * Test TileGraph fill vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph fill matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::fill<fp32_t>(v, tx);
