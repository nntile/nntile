 ...
 *
 * @file tests/graph/tile/gelutanh_inplace.cc
 * TileGraph gelutanh_inplace vs nntile::core::tile::gelutanh_inplace (in-place parity B).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph gelutanh_inplace matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::gelutanh_inplace<fp32_t>(td);
