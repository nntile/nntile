 ...
 *
 * @file tests/graph/tile/sqrt_inplace.cc
 * TileGraph sqrt_inplace vs nntile::core::tile::sqrt_inplace (in-place parity B).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph sqrt_inplace matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::sqrt_inplace<fp32_t>(td);
