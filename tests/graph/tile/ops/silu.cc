 ...
 * TileGraph silu vs nntile::core::tile::silu (small parity B).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph silu matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::silu<fp32_t>(ts, td);
