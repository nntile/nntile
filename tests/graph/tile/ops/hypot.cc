 ...
 * Test TileGraph hypot vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph hypot matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::Tile<fp32_t> t1(sh), t2(sh), td(sh);
    ...
    nntile::core::tile::hypot<fp32_t>(alpha, t1, beta, t2, td);
