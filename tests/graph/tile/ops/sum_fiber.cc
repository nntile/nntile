 ...
 * Test TileGraph sum fiber vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph sum_fiber matches tile (axis=0)", "[graph][tile]")
{
    ...
    nntile::core::tile::Tile<fp32_t> ts(sh), td(dh);
    ...
    nntile::core::tile::sum_fiber<fp32_t>(alpha, ts, beta, td, axis, batch_ndim, redux);
