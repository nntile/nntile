 ...
 * Test TileGraph sum slice vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph sum_slice (axis=0)", "[graph][tile]")
{
    ...
    nntile::core::tile::sum_slice<fp32_t>(a, ts, b, td, axis, redux);
