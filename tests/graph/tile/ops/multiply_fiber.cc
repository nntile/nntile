 ...
 *
 * @file tests/graph/tile/multiply_fiber.cc
 * Test TileGraph multiply fiber vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph multiply_fiber matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::multiply_fiber<fp32_t>(alpha, t1, t2, dst, axis);
