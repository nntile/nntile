 ...
 *
 * @file tests/graph/tile/relu_inplace.cc
 * TileGraph relu_inplace vs nntile::core::tile::relu_inplace (in-place parity B).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph relu_inplace matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::relu_inplace<fp32_t>(td);
