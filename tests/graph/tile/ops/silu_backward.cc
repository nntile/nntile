 ...
 *
 * @file tests/graph/tile/silu_backward.cc
 * Test TileGraph silu backward vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph silu_backward matches tile", "[graph][tile]")
{
    ...
    nntile::core::tile::silu_backward<fp32_t>(tx, tdy, tdx);
