 ...
 * Test TileGraph sumprod slice vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph sumprod_slice (axis=0)", "[graph][tile]")
{
    ...
    nntile::core::tile::sumprod_slice<fp32_t>(a, t1, t2, b, td, ax, redux);
