 ...
 * Test TileGraph add fiber inplace vs nntile::core::tile (parity).
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture, "TileGraph add_fiber_inplace", "[graph][tile]")
{
    ...
    nntile::core::tile::add_fiber_inplace<fp32_t>(a, ts, b, td, axis, batch);
