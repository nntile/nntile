...
TEST_CASE("TensorGraph scatter rejects null", "[graph][tensor]")
{
    ...
    REQUIRE_THROWS_AS(scatter(nullptr, dst), std::invalid_argument);
    REQUIRE_THROWS_AS(scatter(src, nullptr), std::invalid_argument);
}
...
TEST_CASE("TensorGraph scatter rejects shape mismatch", "[graph][tensor]")
{
    ...
    REQUIRE_THROWS_AS(scatter(src, dst), std::invalid_argument);
}

TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph scatter matches tensor::scatter", "[graph][tensor]")
{
