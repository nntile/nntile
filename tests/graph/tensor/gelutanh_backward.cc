...
TEST_CASE("TensorGraph gelutanh_backward structure", "[graph][tensor]")
{
    ...
    auto* dx = gt::gelutanh_backward(x, dy, "dx");
...
TEST_CASE("TensorGraph gelutanh_backward rejects duplicate tensors", "[graph][tensor]")
{
    ...
    REQUIRE_THROWS_AS(gt::gelutanh_backward(x, x, "dx"), std::invalid_argument);
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph gelutanh_backward matches nntile::tensor::gelutanh_backward", "[graph][tensor]")
{
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph gelutanh_backward tiled matches untiled", "[graph][tensor]")
{
    const auto shape = GENERATE(
