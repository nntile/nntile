...
TEST_CASE("TensorGraph silu_backward structure", "[graph][tensor]")
{
    ...
    auto* dx = gt::silu_backward(x, dy, "dx");
...
TEST_CASE("TensorGraph silu_backward rejects duplicate tensors", "[graph][tensor]")
{
    ...
    REQUIRE_THROWS_AS(gt::silu_backward(x, x, "dx"), std::invalid_argument);
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph silu_backward matches nntile::tensor::silu_backward", "[graph][tensor]")
{
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph silu_backward tiled matches untiled", "[graph][tensor]")
{
    const auto shape = GENERATE(
