 ...
 * Test TensorGraph gelutanh operation against nntile::core::tensor::gelutanh.
 *
 * @version 1.1.0
 * */
...
void check_gelutanh_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::core::tensor::gelutanh<T>(src, dst);
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph gelutanh matches nntile::core::tensor::gelutanh",
    "[graph][tensor]")
{
    ...
    check_gelutanh_vs_tensor_api<nntile::core::fp32_t>(shape);
}
