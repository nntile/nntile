 ...
 * nntile::core::tensor::silu_inplace.
 *
 * @version 1.1.0
 * */
...
void check_silu_inplace_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::core::tensor::silu_inplace<T>(dst);
...
TEST_CASE("TensorGraph silu_inplace structure", "[graph][tensor]")
{
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph silu_inplace matches nntile::core::tensor::silu_inplace",
    "[graph][tensor]")
{
    ...
    check_silu_inplace_vs_tensor_api<nntile::core::fp32_t>(shape);
}
