 ...
 * Test TensorGraph gelu_backward operation against
 * nntile::core::tensor::gelu_backward.
 *
 * @version 1.1.0
 * */
...
template <typename T>
void check_gelu_backward_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::core::tensor::gelu_backward<T>(x_t, dy_t, dx_t);
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph gelu_backward matches nntile::core::tensor::gelu_backward",
    "[graph][tensor]")
{
    ...
    check_gelu_backward_vs_tensor_api<nntile::core::fp32_t>(shape);
}
