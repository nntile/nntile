 ...
 * Test TensorGraph gelutanh_backward operation against
 * nntile::core::tensor::gelutanh_backward.
 *
 * @version 1.1.0
 * */
...
template <typename T>
void check_gelutanh_backward_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::core::tensor::gelutanh_backward<T>(x_t, dy_t, dx_t);
...
TEST_CASE("TensorGraph gelutanh_backward structure", "[graph][tensor]")
{
    ...
    auto *dx = gt::gelutanh_backward(x, dy)->set_name("dx");
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph gelutanh_backward matches nntile::core::tensor::gelutanh_backward",
    "[graph][tensor]")
{
    ...
    check_gelutanh_backward_vs_tensor_api<nntile::core::fp32_t>(shape);
}
