 ...
 * Test TensorGraph norm_fiber_inplace operation against
 * nntile::core::tensor::norm_fiber_inplace.
 *
 * @version 1.1.0
 * */
    ...
    Scalar beta)
{
    ...
    auto *src_node = graph.data(tensor_shape, DataType::FP32)->set_name("src");
    ...
    nntile::core::tensor::TensorTraits src_traits(tensor_shape, tensor_shape);
    nntile::core::tensor::TensorTraits dst_traits(fiber_sh, fiber_sh);
    ...
    nntile::core::tensor::norm_fiber_inplace<T>(
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph norm_fiber_inplace matches "
    "nntile::core::tensor::norm_fiber_inplace",
    "[graph][tensor]")
{
    ...
    check_norm_fiber_inplace_vs_tensor_api<nntile::core::fp32_t>(
