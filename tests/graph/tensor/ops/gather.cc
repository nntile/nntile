 ...
 * Test TensorGraph gather operation against nntile::core::tensor::gather.
 *
 * @version 1.1.0
 * */
...
void check_gather_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::core::tensor::gather<T>(src_t, dst_t);
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph gather matches nntile::core::tensor::gather",
    "[graph][tensor]")
{
    ...
    check_gather_vs_tensor_api<nntile::core::fp32_t>(shape);
}
