 ...
 * Test TensorGraph silu operation against nntile::core::tensor::silu.
 *
 * @version 1.1.0
 * */
...
template <typename T>
void check_silu_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    auto *dst_node = gt::silu(src_node);
    ...
    nntile::core::tensor::silu<T>(src, dst);
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph silu matches nntile::core::tensor::silu",
    "[graph][tensor]")
{
    ...
    check_silu_vs_tensor_api<nntile::core::fp32_t>(shape);
}
