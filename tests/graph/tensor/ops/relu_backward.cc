 ...
 * nntile::core::tensor::relu_backward.
 *
 * @version 1.1.0
 * */
...
void check_relu_backward_vs_tensor_api(const std::vector<Index> &shape)
{
    ...
    nntile::core::tensor::relu_backward<T>(x_t, dy_t, dx_t);
...
TEST_CASE_METHOD(nntile::core::test::ContextFixture,
    "TensorGraph relu_backward matches nntile::core::tensor::relu_backward",
    "[graph][tensor]")
{
    ...
    check_relu_backward_vs_tensor_api<nntile::core::fp32_t>(shape);
}
