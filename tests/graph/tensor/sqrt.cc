...
template<typename T>
void check_sqrt_vs_tensor_api(const std::vector<Index>& shape)
{
    ...
    auto* dst_node = sqrt(src_node, "dst");
...
TEST_CASE("TensorGraph sqrt matches tensor::sqrt", "[graph][tensor]")
{
