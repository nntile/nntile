...
template<typename T>
void check_adamw_step_vs_tensor_api(
    ...
    Scalar weight_decay)
{
    ...
    adamw_step(num_iter, beta_1, beta_2, eps, lr, weight_decay,
    ...
    tensor::adamw_step<T>(num_iter, beta_1, beta_2, eps, lr, weight_decay,
...
TEST_CASE("TensorGraph adamw_step structure", "[graph][tensor]")
{
    ...
    adamw_step(1, 0.9, 0.999, 1e-8, 0.001, 0.01,
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph adamw_step matches tensor::adamw_step", "[graph][tensor]")
{
