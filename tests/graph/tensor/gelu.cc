    ...
    const std::vector<Index>& shape)
{
    ...
    auto* dst_node = gt::gelu(src_node, "dst");
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph gelu matches nntile::tensor::gelu", "[graph][tensor]")
{
...
TEST_CASE_METHOD(nntile::test::ContextFixture,
    "TensorGraph gelu tiled matches untiled", "[graph][tensor]")
{
    const auto shape = GENERATE(
