...
```bash
python tests/graph/model/gpt2/generate_test_data.py --block mlp --output /tmp/gpt2_data --seed 42
python tests/graph/model/gpt2/generate_test_data.py --block attention --output /tmp/gpt2_data --seed 42
python tests/graph/model/gpt2/generate_test_data.py --block attention_causal --output /tmp/gpt2_data --seed 42
python tests/graph/model/gpt2/generate_test_data.py --block block --output /tmp/gpt2_data --seed 42
python tests/graph/model/gpt2/generate_test_data.py --block model --output /tmp/gpt2_data --seed 42
python tests/graph/model/gpt2/generate_test_data.py --block causal --output /tmp/gpt2_data --seed 42
```
