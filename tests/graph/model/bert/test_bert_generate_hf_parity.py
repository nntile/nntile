...
# Regression: BERT generate_test_data uses full HF forwards, not a local reimplementation.
#
# @version 1.1.0

"""Guard that BERT graph fixtures track HuggingFace ``modeling_bert`` exactly."""
...
from transformers.models.bert.modeling_bert import BertAttention, BertIntermediate
...
def test_attention_weights_match_hf_layout() -> None:
    ...
    w_q = pt.self.query.weight.detach().numpy().reshape(
