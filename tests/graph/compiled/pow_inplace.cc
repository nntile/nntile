 ...
 *
 * @file tests/graph/compiled/pow_inplace.cc
 * Test for compiled graph pow_inplace operation.
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(
    GraphTestFixture,
    "CompiledGraph PowInplace vs Tensor",
    "[graph][verification]")
{
    ...
    auto run_tensor_direct = [](std::map<std::string, std::vector<float>>& inputs,
        ...
        nntile::tensor::pow<T>(2.0f, 2.0f, x);
