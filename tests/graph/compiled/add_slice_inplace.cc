 ...
 *
 * @file tests/graph/compiled/add_slice_inplace.cc
 * Test for compiled graph add_slice_inplace operation.
 *
 * @version 1.1.0
 * */
    ...
    "[graph][verification]")
{
    ...
    auto run_tensor_direct = [](std::map<std::string, std::vector<float>>& inputs,
        ...
        nntile::tensor::add_slice_inplace<T>(2.0f, x, 3.0f, y, 0);
