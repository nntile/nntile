 ...
 *
 * @file tests/graph/compiled/norm_fiber_inplace.cc
 * Test for compiled graph norm_fiber_inplace operation.
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(
    GraphTestFixture,
    "CompiledGraph NormFiberInplace vs Tensor",
    "[graph][verification]")
{
    ...
    auto run_tensor_direct = [](std::map<std::string, std::vector<float>>& inputs,
        ...
        nntile::tensor::norm_fiber_inplace<T>(2.0f, x, 3.0f, y, 0, 0);
