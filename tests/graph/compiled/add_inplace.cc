 ...
 *
 * @file tests/graph/compiled/add_inplace.cc
 * Test for compiled graph add_inplace operation.
 *
 * @version 1.1.0
 * */
    ...
    "[graph][verification]")
{
    ...
    auto run_tensor_direct = [](std::map<std::string, std::vector<float>>& inputs,
        ...
        nntile::tensor::add_inplace<T>(2.0f, x, 3.0f, y);
