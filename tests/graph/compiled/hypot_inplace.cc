 ...
 *
 * @file tests/graph/compiled/hypot_inplace.cc
 * Test for compiled graph hypot_inplace operation.
 *
 * @version 1.1.0
 * */
...
TEST_CASE_METHOD(
    GraphTestFixture,
    "CompiledGraph HypotInplace vs Tensor",
    "[graph][verification]")
{
    ...
    auto run_tensor_direct = [](std::map<std::string, std::vector<float>>& inputs,
        ...
        nntile::tensor::hypot_inplace<T>(2.0f, x, 3.0f, y);
