...
void validate()
{
    ...
    starpu::adam_step.submit<std::tuple<T>>(num_iter, p.nelems, beta1, beta2,
            eps, lr, wd, grad, m, v, p);
    adam_step<T>(num_iter, beta1, beta2, eps, lr, wd, grad, m_ref, v_ref,
            p_ref);
