...
void validate_cpu(Index nelems)
{
    ...
    std::cout << "Run starpu::relu::submit<" << T::type_repr << "> restricted to CPU\n";
    ...
    std::cout << "OK: starpu::relu::submit<" << T::type_repr << "> restricted to CPU\n";
}
...
void validate_cuda(Index nelems)
{
    ...
    std::cout << "Run starpu::relu::submit<" << T::type_repr << "> restricted to CUDA\n";
    relu::submit<T>(nelems, data2_handle);
    starpu_task_wait_for_all();
    data2_handle.unregister();
    // Check result
    ...
    std::cout << "OK: starpu::relu::submit<" << T::type_repr << "> restricted to CUDA\n";
}
#endif // NNTILE_USE_CUDA
