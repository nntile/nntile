...
using namespace nntile::core::kernel::scale_fiber;
...
// Catch2-based tests
TEMPLATE_TEST_CASE(
    "Scale Fiber Kernel Verification",
    "[scale_fiber]",
    fp64_t,
    fp32_t,
    fp16_t,
...
)
{
    ...
    auto data = get_test_input_data<T>(m, n, k, batch, alpha, strategy);
