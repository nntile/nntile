...
hidden_size_list = [512 * i for i in range(1, 21)]
...
cmd_string = "CUDA_VISIBLE_DEVICES=0 STARPU_WORKERS_NOBIND=1 STARPU_SILENT=1 STARPU_NCPU=1 STARPU_NCUDA=1 python3 llama_perf.py --config-path=./llama_default_config.json"
...
for seq_len in seq_len_list:
    ...
    current_cmd = current_cmd + " --results-folder=.results/" + submodule + "_" + mode +"/seq-len_" + str(seq_len)
