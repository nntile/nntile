...
if __name__ == "__main__":
    ...
    final_layer_output_tm = nntile.tensor.TensorMoments(final_layer_output_tensor, None, True)
    ...
    ntile_xentropy_np = np.zeros((1,), dtype=np.float32, order="F")
    xentropy_loss.get_val(ntile_xentropy_np)

    print("NNtile x-entropy =", ntile_xentropy_np[0])
