...
#
# @file wrappers/python/examples/llama_generate.py
# LLaMA generate example
#
# @version 1.1.0
...
from nntile.model.llama_causal import LlamaForCausalLM as LlamaModel
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Example with LLM inference for LLaMA model",
    )
