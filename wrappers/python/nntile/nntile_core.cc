...
void def_mod_tile(py::module_ &m)
{
    ...
    def_class_tile<fp16_t>(m, "Tile_fp16");
}
...
void def_mod_tensor(py::module_ &m)
{
    ...
    m.def("relu_inplace_async_fp64", &relu_inplace_async<fp64_t>);
    m.def("relu_inplace_async_fp32", &relu_inplace_async<fp32_t>);
    m.def("relu_inplace_async_fp32_fast_tf32", &relu_inplace_async<fp32_fast_tf32_t>);
    m.def("relu_inplace_async_fp32_fast_fp16", &relu_inplace_async<fp32_fast_fp16_t>);
    m.def("relu_inplace_async_fp32_fast_bf16", &relu_inplace_async<fp32_fast_bf16_t>);
    m.def("relu_inplace_async_bf16", &relu_inplace_async<bf16_t>);
    m.def("relu_inplace_async_fp16", &relu_inplace_async<fp16_t>);

    m.def("relu_inplace_fp64", &relu_inplace<fp64_t>);
    m.def("relu_inplace_fp32", &relu_inplace<fp32_t>);
    m.def("relu_inplace_fp32_fast_tf32", &relu_inplace<fp32_fast_tf32_t>);
    m.def("relu_inplace_fp32_fast_fp16", &relu_inplace<fp32_fast_fp16_t>);
    m.def("relu_inplace_fp32_fast_bf16", &relu_inplace<fp32_fast_bf16_t>);
    m.def("relu_inplace_bf16", &relu_inplace<bf16_t>);
    m.def("relu_inplace_fp16", &relu_inplace<fp16_t>);
    ...
    m.def("relu_async_fp16", &relu_async<fp16_t>);
    ...
    m.def("silu_backward_async_fp16", &silu_backward_async<fp16_t>);
    ...
    m.def("silu_backward_fp16", &silu_backward<fp16_t>);
    ...
    m.def("fill_async_fp16", &fill_async<fp16_t>);
    ...
    m.def("sum_slice_async_fp16", &sum_slice_async<fp16_t>);
    ...
    m.def("sum_slice_fp32_fast_bf16", &sum_slice<fp32_fast_bf16_t>);
    m.def("sum_slice_bf16", &sum_slice<bf16_t>);
    m.def("sum_slice_fp16", &sum_slice<fp16_t>);
    ...
    m.def("sum_fiber_async_fp16", &sum_fiber_async<fp16_t>);
    ...
    m.def("sum_fiber_fp16", &sum_fiber<fp16_t>);
    ...
    m.def("norm_async_fp32_fast_tf32", &norm_async<fp32_fast_tf32_t>);
    m.def("norm_async_fp32_fast_fp16", &norm_async<fp32_fast_fp16_t>);
    m.def("norm_async_fp32_fast_bf16", &norm_async<fp32_fast_bf16_t>);
    m.def("norm_async_bf16", &norm_async<bf16_t>);
    m.def("norm_async_fp16", &norm_async<fp16_t>);

    m.def("norm_fp64", &norm<fp64_t>);
    m.def("norm_fp32", &norm<fp32_t>);
    m.def("norm_fp32_fast_tf32", &norm<fp32_fast_tf32_t>);
    m.def("norm_fp32_fast_fp16", &norm<fp32_fast_fp16_t>);
    m.def("norm_fp32_fast_bf16", &norm<fp32_fast_bf16_t>);
    m.def("norm_bf16", &norm<bf16_t>);
    m.def("norm_fp16", &norm<fp16_t>);

    m.def("isfinite_fp64", &isfinite<fp64_t>);
    m.def("isfinite_fp32", &isfinite<fp32_t>);
    m.def("isfinite_fp32_fast_tf32", &isfinite<fp32_fast_tf32_t>);
    m.def("isfinite_fp32_fast_fp16", &isfinite<fp32_fast_fp16_t>);
    m.def("isfinite_fp32_fast_bf16", &isfinite<fp32_fast_bf16_t>);
    m.def("isfinite_bf16", &isfinite<bf16_t>);
    m.def("isfinite_fp16", &isfinite<fp16_t>);

    m.def("isfinite_async_fp64", &isfinite_async<fp64_t>);
    m.def("isfinite_async_fp32", &isfinite_async<fp32_t>);
    m.def("isfinite_async_fp32_fast_tf32", &isfinite_async<fp32_fast_tf32_t>);
    m.def("isfinite_async_fp32_fast_fp16", &isfinite_async<fp32_fast_fp16_t>);
    m.def("isfinite_async_fp32_fast_bf16", &isfinite_async<fp32_fast_bf16_t>);
    m.def("isfinite_async_bf16", &isfinite_async<bf16_t>);
    m.def("isfinite_async_fp16", &isfinite_async<fp16_t>);
    ...
    m.def("softmax_async_fp16", &softmax_async<fp16_t>);
    ...
    m.def("softmax_fp16", &softmax<fp16_t>);
    ...
    m.def("softmax_inplace_async_fp16", &softmax_inplace_async<fp16_t>);
    ...
    m.def("scatter_fp16", &scatter<fp16_t>);
    ...
    m.def("maxsumexp_async_fp16", &maxsumexp_async<fp16_t>);
    ...
    m.def("maxsumexp_fp16", &maxsumexp<fp16_t>);
    ...
    m.def("add_slice_inplace_async_fp16", &add_slice_inplace_async<fp16_t>);
    ...
    m.def("add_inplace_async_fp16", &add_inplace_async<fp16_t>);
    ...
    m.def("add_fiber_inplace_async_fp16", &add_fiber_inplace_async<fp16_t>);
    ...
    m.def("add_fiber_inplace_fp16", &add_fiber_inplace<fp16_t>);

    m.def("scale_fiber_async_fp64", &scale_fiber_async<fp64_t>);
    m.def("scale_fiber_async_fp32", &scale_fiber_async<fp32_t>);
    m.def("scale_fiber_async_fp32_fast_tf32", &scale_fiber_async<fp32_fast_tf32_t>);
    m.def("scale_fiber_async_fp32_fast_fp16", &scale_fiber_async<fp32_fast_fp16_t>);
    m.def("scale_fiber_async_fp32_fast_bf16", &scale_fiber_async<fp32_fast_bf16_t>);
    m.def("scale_fiber_async_bf16", &scale_fiber_async<bf16_t>);
    m.def("scale_fiber_async_fp16", &scale_fiber_async<fp16_t>);

    m.def("scale_fiber_fp64", &scale_fiber<fp64_t>);
    m.def("scale_fiber_fp32", &scale_fiber<fp32_t>);
    m.def("scale_fiber_fp32_fast_tf32", &scale_fiber<fp32_fast_tf32_t>);
    m.def("scale_fiber_fp32_fast_fp16", &scale_fiber<fp32_fast_fp16_t>);
    m.def("scale_fiber_fp32_fast_bf16", &scale_fiber<fp32_fast_bf16_t>);
    m.def("scale_fiber_bf16", &scale_fiber<bf16_t>);
    m.def("scale_fiber_fp16", &scale_fiber<fp16_t>);
    ...
    m.def("multiply_slice_async_fp64", &multiply_slice_async<fp64_t>);
    m.def("multiply_slice_async_fp32", &multiply_slice_async<fp32_t>);
    m.def("multiply_slice_async_fp32_fast_tf32", &multiply_slice_async<fp32_fast_tf32_t>);
    m.def("multiply_slice_async_fp32_fast_fp16", &multiply_slice_async<fp32_fast_fp16_t>);
    m.def("multiply_slice_async_fp32_fast_bf16", &multiply_slice_async<fp32_fast_bf16_t>);
    m.def("multiply_slice_async_bf16", &multiply_slice_async<bf16_t>);
    m.def("multiply_slice_async_fp16", &multiply_slice_async<fp16_t>);

    m.def("multiply_slice_fp64", &multiply_slice<fp64_t>);
    m.def("multiply_slice_fp32", &multiply_slice<fp32_t>);
    m.def("multiply_slice_fp32_fast_tf32", &multiply_slice<fp32_fast_tf32_t>);
    m.def("multiply_slice_fp32_fast_fp16", &multiply_slice<fp32_fast_fp16_t>);
    m.def("multiply_slice_fp32_fast_bf16", &multiply_slice<fp32_fast_bf16_t>);
    m.def("multiply_slice_bf16", &multiply_slice<bf16_t>);
    m.def("multiply_slice_fp16", &multiply_slice<fp16_t>);

    m.def("multiply_fiber_inplace_async_fp64", &multiply_fiber_inplace_async<fp64_t>);
    m.def("multiply_fiber_inplace_async_fp32", &multiply_fiber_inplace_async<fp32_t>);
    m.def("multiply_fiber_inplace_async_fp32_fast_tf32", &multiply_fiber_inplace_async<fp32_fast_tf32_t>);
    m.def("multiply_fiber_inplace_async_fp32_fast_fp16", &multiply_fiber_inplace_async<fp32_fast_fp16_t>);
    m.def("multiply_fiber_inplace_async_fp32_fast_bf16", &multiply_fiber_inplace_async<fp32_fast_bf16_t>);
    m.def("multiply_fiber_inplace_async_bf16", &multiply_fiber_inplace_async<bf16_t>);

    m.def("multiply_fiber_inplace_fp64", &multiply_fiber_inplace<fp64_t>);
    m.def("multiply_fiber_inplace_fp32", &multiply_fiber_inplace<fp32_t>);
    m.def("multiply_fiber_inplace_fp32_fast_tf32", &multiply_fiber_inplace<fp32_fast_tf32_t>);
    m.def("multiply_fiber_inplace_fp32_fast_fp16", &multiply_fiber_inplace<fp32_fast_fp16_t>);
    ...
    m.def("logsumexp_async_fp16", &logsumexp_async<fp16_t>);
    ...
    m.def("logsumexp_fp16", &logsumexp<fp16_t>);
    ...
    m.def("total_sum_accum_async_fp16", &total_sum_accum_async<fp16_t>);
    ...
    m.def("total_sum_accum_fp16", &total_sum_accum<fp16_t>);
    ...
    m.def("subtract_indexed_outputs_async_fp16",
            &subtract_indexed_outputs_async<fp16_t>);
    ...
    m.def("adam_step_async_fp16", &adam_step_async<fp16_t>);
    ...
    m.def("adam_step_fp16", &adam_step<fp16_t>);
    ...
    m.def("adamw_step_async_fp16", &adamw_step_async<fp16_t>);
    ...
    m.def("sumprod_slice_fp16", &sumprod_slice<fp16_t>);
    ...
    m.def("sumprod_fiber_async_fp16", &sumprod_fiber_async<fp16_t>);
    ...
    m.def("gelu_backward_async_fp16", &gelu_backward_async<fp16_t>);
    ...
    m.def("gelu_backward_fp16", &gelu_backward<fp16_t>);
    ...
    m.def("gelutanh_backward_async_fp16", &gelutanh_backward_async<fp16_t>);
    ...
    m.def("embedding_async_fp16", &embedding_async<fp16_t>);
    ...
    m.def("embedding_fp16", &embedding<fp16_t>);
    ...
    m.def("mask_scalar_async_fp16", &mask_scalar_async<fp16_t>);
    ...
    m.def("hypot_scalar_inverse_async_fp16", &hypot_scalar_inverse_async<fp16_t>);
    ...
    m.def("hypot_scalar_inverse_fp16", &hypot_scalar_inverse<fp16_t>);
    ...
    m.def("transpose_async_fp16", &transpose_async<fp16_t>);
    ...
    m.def("transpose_fp16", &transpose<fp16_t>);
    ...
    m.def("flash_sdpa_bwd_cudnn_async_bf16", &flash_sdpa_bwd_cudnn_async<bf16_t>);
    m.def("flash_sdpa_bwd_cudnn_async_fp16", &flash_sdpa_bwd_cudnn_async<fp16_t>);

    m.def("flash_sdpa_bwd_cudnn_bf16", &flash_sdpa_bwd_cudnn<bf16_t>);
    m.def("flash_sdpa_bwd_cudnn_fp16", &flash_sdpa_bwd_cudnn<fp16_t>);
}
