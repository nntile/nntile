...
void def_mod_tensor(py::module_ &m)
{
    ...
    m.def("lamb_step_async_fp64", &lamb_step_async<fp64_t>);
    m.def("lamb_step_async_fp32", &lamb_step_async<fp32_t>);
    m.def("lamb_step_async_fp32_fast_tf32", &lamb_step_async<fp32_fast_tf32_t>);
    m.def("lamb_step_async_fp32_fast_fp16", &lamb_step_async<fp32_fast_fp16_t>);
    m.def("lamb_step_async_fp32_fast_bf16", &lamb_step_async<fp32_fast_bf16_t>);
    m.def("lamb_step_async_bf16", &lamb_step_async<bf16_t>);
    m.def("lamb_step_async_fp16", &lamb_step_async<fp16_t>);

    m.def("lamb_step_fp64", &lamb_step<fp64_t>);
    m.def("lamb_step_fp32", &lamb_step<fp32_t>);
    m.def("lamb_step_fp32_fast_tf32", &lamb_step<fp32_fast_tf32_t>);
    m.def("lamb_step_fp32_fast_fp16", &lamb_step<fp32_fast_fp16_t>);
    m.def("lamb_step_fp32_fast_bf16", &lamb_step<fp32_fast_bf16_t>);
    m.def("lamb_step_bf16", &lamb_step<bf16_t>);
    m.def("lamb_step_fp16", &lamb_step<fp16_t>);
