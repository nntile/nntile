...
#
# @file wrappers/python/nntile/optimizer/lion.py
# Implementation of Lion with amsgrad option within nntile package
#
# @version 1.1.0
...
class Lion:
    ...
    def load_state(self, path):
        ...
        for i in range(len(first_moments)):
            ...
            del f
        del stored_states, first_moments
