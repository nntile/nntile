...
def multiply_slice_inplace_async_bf16(alpha: float, src: Tensor_bf16, beta: float, dst: Tensor_bf16, axis: int) -> None: ...
def multiply_slice_inplace_async_fp32(alpha: float, src: Tensor_fp32, beta: float, dst: Tensor_fp32, axis: int) -> None: ...
def multiply_slice_inplace_async_fp32_fast_tf32(alpha: float, src: Tensor_fp32_fast_tf32, beta: float, dst: Tensor_fp32_fast_tf32, axis: int) -> None: ...
def multiply_slice_inplace_async_fp64(alpha: float, src: Tensor_fp64, beta: float, dst: Tensor_fp64, axis: int) -> None: ...
def multiply_slice_inplace_bf16(alpha: float, src: Tensor_bf16, beta: float, dst: Tensor_bf16, axis: int) -> None: ...
def multiply_slice_inplace_fp32(alpha: float, src: Tensor_fp32, beta: float, dst: Tensor_fp32, axis: int) -> None: ...
def multiply_slice_inplace_fp32_fast_tf32(alpha: float, src: Tensor_fp32_fast_tf32, beta: float, dst: Tensor_fp32_fast_tf32, axis: int) -> None: ...
def multiply_slice_inplace_fp64(alpha: float, src: Tensor_fp64, beta: float, dst: Tensor_fp64, axis: int) -> None: ...
