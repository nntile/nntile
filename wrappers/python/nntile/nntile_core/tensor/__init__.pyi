...
def normalize_async_fp32(gamma_beta: Tensor_fp32, src: Tensor_fp32, dst: Tensor_fp32, l: int, eps: float, axis: int) -> None: ...
def normalize_async_fp64(gamma_beta: Tensor_fp64, src: Tensor_fp64, dst: Tensor_fp64, l: int, eps: float, axis: int) -> None: ...
def normalize_fp32(gamma_beta: Tensor_fp32, src: Tensor_fp32, dst: Tensor_fp32, l: int, eps: float, axis: int) -> None: ...
def normalize_fp64(gamma_beta: Tensor_fp64, src: Tensor_fp64, dst: Tensor_fp64, l: int, eps: float, axis: int) -> None: ...
