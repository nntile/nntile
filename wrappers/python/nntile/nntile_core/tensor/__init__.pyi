...
def lion_step_async_bf16(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_bf16, first_moment: Tensor_bf16, second_moment: Tensor_bf16, p: Tensor_bf16) -> None: ...
def lion_step_async_fp32(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_fp32, first_moment: Tensor_fp32, second_moment: Tensor_fp32, p: Tensor_fp32) -> None: ...
def lion_step_async_fp32_fast_tf32(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_fp32_fast_tf32, first_moment: Tensor_fp32_fast_tf32, second_moment: Tensor_fp32_fast_tf32, p: Tensor_fp32_fast_tf32) -> None: ...
def lion_step_async_fp64(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_fp64, first_moment: Tensor_fp64, second_moment: Tensor_fp64, p: Tensor_fp64) -> None: ...
def lion_step_bf16(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_bf16, first_moment: Tensor_bf16, second_moment: Tensor_bf16, p: Tensor_bf16) -> None: ...
def lion_step_fp32(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_fp32, first_moment: Tensor_fp32, second_moment: Tensor_fp32, p: Tensor_fp32) -> None: ...
def lion_step_fp32_fast_tf32(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_fp32_fast_tf32, first_moment: Tensor_fp32_fast_tf32, second_moment: Tensor_fp32_fast_tf32, p: Tensor_fp32_fast_tf32) -> None: ...
def lion_step_fp64(num_iter: int, beta_1: float, beta_2: float, eps: float, lr: float, weight_decay: float, grad: Tensor_fp64, first_moment: Tensor_fp64, second_moment: Tensor_fp64, p: Tensor_fp64) -> None: ...
