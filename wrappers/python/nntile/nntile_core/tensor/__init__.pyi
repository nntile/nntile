...
def prod_fiber_inplace_async_fp32(alpha: float, src: Tensor_fp32, dst: Tensor_fp32, axis: int) -> None: ...
def prod_fiber_inplace_async_fp64(alpha: float, src: Tensor_fp64, dst: Tensor_fp64, axis: int) -> None: ...
def prod_fiber_inplace_fp32(alpha: float, src: Tensor_fp32, dst: Tensor_fp32, axis: int) -> None: ...
def prod_fiber_inplace_fp64(alpha: float, src: Tensor_fp64, dst: Tensor_fp64, axis: int) -> None: ...
