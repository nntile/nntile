...
def lars_tiled_step_async_bf16(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_bf16, momentum_buffer: Tensor_bf16, p: Tensor_bf16) -> None: ...
def lars_tiled_step_async_fp32(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_fp32, momentum_buffer: Tensor_fp32, p: Tensor_fp32) -> None: ...
def lars_tiled_step_async_fp32_fast_tf32(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_fp32_fast_tf32, momentum_buffer: Tensor_fp32_fast_tf32, p: Tensor_fp32_fast_tf32) -> None: ...
def lars_tiled_step_async_fp64(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_fp64, momentum_buffer: Tensor_fp64, p: Tensor_fp64) -> None: ...
def lars_tiled_step_bf16(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_bf16, momentum_buffer: Tensor_bf16, p: Tensor_bf16) -> None: ...
def lars_tiled_step_fp32(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_fp32, momentum_buffer: Tensor_fp32, p: Tensor_fp32) -> None: ...
def lars_tiled_step_fp32_fast_tf32(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_fp32_fast_tf32, momentum_buffer: Tensor_fp32_fast_tf32, p: Tensor_fp32_fast_tf32) -> None: ...
def lars_tiled_step_fp64(num_iter: int, num_steps: int, gamma0: float, momentum: float, weight_decay: float, lars_coefficient: float, grad: Tensor_fp64, momentum_buffer: Tensor_fp64, p: Tensor_fp64) -> None: ...
