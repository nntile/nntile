...
class Tensor(Protocol):
    def __init__(self, traits: TensorTraits, distr: list[int] = ..., last_tag: int = ..., name: str = ...) -> None: ...
...
class Tensor_fp32_fast_tf32(Tensor):
    def __init__(self, traits: TensorTraits, distr: list[int] = ..., last_tag: int = ..., name: str = ...) -> None: ...
class Tensor_fp32_fast_bf16(Tensor):
    def __init__(self, traits: TensorTraits, distr: list[int] = ..., last_tag: int = ..., name: str = ...) -> None: ...
class Tensor_fp32_fast_fp16(Tensor):
    def __init__(self, traits: TensorTraits, distr: list[int] = ..., last_tag: int = ..., name: str = ...) -> None: ...
