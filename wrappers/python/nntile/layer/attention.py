...
from nntile.tensor import TensorTraits, Tensor, TensorOrNone, TensorMoments, \
        ...
        add_slice_async, prod_async, add_fiber_async, sum_fiber_async
    ...
    def forward_async(self):
        ...
        for i in range(self.n_head):
            ...
            if self.in_proj_bias_q:
                add_fiber_async(1, self.in_proj_bias_q[i].value, 1, self.q[i].value, 0)
            ...
            if self.in_proj_bias_k:
                add_fiber_async(1, self.in_proj_bias_k[i].value, 1, self.k[i].value, 0)
            ...
            if self.in_proj_bias_v:
                add_fiber_async(1, self.in_proj_bias_v[i].value, 1, self.v[i].value, 0)
    ...
    def backward_async(self):
        ...
        for i in range(self.n_head):
            ...
            if self.in_proj_bias_v[i] and self.in_proj_bias_v[i].grad_required:
                sum_fiber_async(1, self.v[i].grad, 1, self.in_proj_bias_v[i].grad, 0)
            ...
            if self.in_proj_bias_k[i] and self.in_proj_bias_k[i].grad_required:
                sum_fiber_async(1, self.k[i].grad, 1, self.in_proj_bias_k[i].grad, 0)
            ...
            if self.in_proj_bias_q[i] and self.in_proj_bias_q[i].grad_required:
                sum_fiber_async(1, self.q[i].grad, 1, self.in_proj_bias_q[i].grad, 0)
