...
def fused_muon_step(
    ...
    if type(p) is not type(second_moment):
        raise TypeError
    if type(p) is core_tensor.Tensor_fp32:
        core_tensor.muon_step_async_fp32(
            num_iter,
            beta1,
            beta2,
            eps,
        ...
        core_tensor.muon_step_async_fp32_fast_tf32(
            num_iter,
            beta1,
            beta2,
            eps,
        ...
        core_tensor.muon_step_async_fp32_fast_fp16(
            num_iter,
            beta1,
            beta2,
            eps,
        ...
        core_tensor.muon_step_async_fp32_fast_bf16(
            num_iter,
            beta1,
            beta2,
            eps,
        ...
        core_tensor.muon_step_async_fp64(
            num_iter,
            beta1,
            beta2,
            eps,
        ...
        core_tensor.muon_step_async_bf16(
            num_iter,
            beta1,
            beta2,
            eps,
