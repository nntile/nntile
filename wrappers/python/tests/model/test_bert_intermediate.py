...
#
# @file wrappers/python/tests/model/test_bert_intermediate.py
# Test for nntile.model.bert_modules.bert_intermediate
...
def generate_inputs(params: BertTestParams,
    ...
    torch_model = BertIntermediate_torch(torch_config)
    ...
    y_grad_random = gen.standard_normal((params.intermediate_size,
                                         params.seq_len,
                                         params.batch_size),
                                         dtype=np.float32)
