...
#
# @file wrappers/python/tests/model/test_bert_embeddings.py
# Test for nntile.model.bert_modules.bert_embeddings
...
from nntile.model.bert_modules import BertEmbeddings as BertEmbeddingsNNTile
...
def generate_inputs(params: BertTestParams,
    ...
    nntile_model, _ = BertEmbeddingsNNTile.from_torch(
