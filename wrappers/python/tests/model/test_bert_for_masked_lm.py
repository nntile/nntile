...
# Test for nntile.model.bert.bert_for_masked_lm
...
from transformers.models.bert.modeling_bert import (
    BertForMaskedLM as BertForMaskedLM_torch)

import nntile
from nntile.model.bert import BertForMaskedLM as BertForMaskedLM
...
def generate_inputs(params: BertTestParams,
    ...
    torch_model = BertForMaskedLM_torch(torch_config)
    # Disentangle weight in final linear layer and first embedding
    torch_model.cls.predictions.decoder.weight = torch.nn.Parameter(
            torch_model.cls.predictions.decoder.weight.detach().clone())
    ...
    nntile_model, _ = BertForMaskedLM.from_torch(
