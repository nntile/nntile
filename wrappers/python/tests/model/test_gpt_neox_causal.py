...
#
# @file wrappers/python/tests/model/test_gpt_neox_causal.py
# Test for nntile.model.gpt_neox_causal
#
# @version 1.1.0
...
from transformers.models.gpt_neox.modeling_gpt_neox import (
    GPTNeoXConfig as ConfigTorch, GPTNeoXForCausalLM as ModelTorch)
...
def generate_inputs(params: GPTNeoXModelTestParams,
    ...
    nntile_model, _ = GPTNeoXForCausalLM.from_torch(
    ...
    y_grad_random = rng.standard_normal((params.vocab_size,
                                         params.n_seq,
                                         params.n_batch),
                                        dtype=np.float32)
