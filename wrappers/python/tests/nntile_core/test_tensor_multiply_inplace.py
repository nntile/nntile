...
#
# @file wrappers/python/tests/nntile/test_tensor_multiply_inplace.py
...
multiply_inplace = {
    np.float32: nntile.core.tensor.multiply_inplace_fp32,
    np.float64: nntile.core.tensor.multiply_inplace_fp64
}
