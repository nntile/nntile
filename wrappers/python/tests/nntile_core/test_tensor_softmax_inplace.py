...
#
# @file wrappers/python/tests/nntile/test_tensor_softmax_inplace.py
...
softmax_inplace = {np.float32: nntile.core.tensor.softmax_inplace_fp32,
                   np.float64: nntile.core.tensor.softmax_inplace_fp64}


@pytest.mark.parametrize('dtype', [np.float32, np.float64])
def test_softmax_inplace(context, dtype):
