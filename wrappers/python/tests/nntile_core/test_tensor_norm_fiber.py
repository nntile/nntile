...
norm_fiber = {np.float32: nntile.nntile_core.tensor.norm_fiber_async_fp32,
        np.float64: nntile.nntile_core.tensor.norm_fiber_async_fp64}
norm_fiber_inplace = {np.float32: nntile.nntile_core.tensor.norm_fiber_inplace_async_fp32,
        np.float64: nntile.nntile_core.tensor.norm_fiber_inplace_async_fp64}

# is better to use itertools to generate random tests?
@pytest.mark.parametrize('dtype,inplace,input_shape', [
(np.float32,True,[3,5,20,20]), (np.float64,True,[3,5,20,20]),
(np.float32,True,[7,5,21,21]), (np.float64,True,[7,5,21,21]),
(np.float32,False,[3,5,20,20]), (np.float64,False,[3,5,20,20]),
(np.float32,False,[7,5,21,21]), (np.float64,False,[7,5,21,21]),
])
