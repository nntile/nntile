...
#
# @file wrappers/python/tests/nntile/test_tensor_multiply.py
...
multiply = {np.float32: nntile.core.tensor.multiply_fp32,
        np.float64: nntile.core.tensor.multiply_fp64}
