...
#
# @file wrappers/python/tests/nntile/test_tensor_copy_intersection.py
...
copy_intersection = {
    np.float32: nntile.core.tensor.copy_intersection_fp32,
    np.float64: nntile.core.tensor.copy_intersection_fp64}
