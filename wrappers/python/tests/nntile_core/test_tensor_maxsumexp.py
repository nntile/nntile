...
#
# @file wrappers/python/tests/nntile/test_tensor_maxsumexp.py
...
maxsumexp = {np.float32: nntile.core.tensor.maxsumexp_fp32,
             np.float64: nntile.core.tensor.maxsumexp_fp64}
