...
#
# @file wrappers/python/tests/nntile/test_tensor_sqrt_inplace.py
...
sqrt_inplace = {np.float32: nntile.core.tensor.sqrt_inplace_fp32,
                np.float64: nntile.core.tensor.sqrt_inplace_fp64}
