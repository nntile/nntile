...
#
# @file wrappers/python/tests/nntile/test_tensor_gather.py
...
gather = {np.float32: nntile.core.tensor.gather_fp32,
          np.float64: nntile.core.tensor.gather_fp64}


@pytest.mark.parametrize('dtype', [np.float32, np.float64])
def test_gather(context, dtype):
