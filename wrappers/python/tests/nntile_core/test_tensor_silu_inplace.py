...
#
# @file wrappers/python/tests/nntile/test_tensor_silu_inplace.py
...
silu_inplace = {np.float32: nntile.core.tensor.silu_inplace_fp32,
                np.float64: nntile.core.tensor.silu_inplace_fp64}
