...
pip install /path/to/torch_nntile-0.0.3-cp312-cp312-manylinux_2_28_x86_64.whl
```
...
```bash
pip install torch==2.9.1
pip install /path/to/torch_nntile-0.0.3-cp312-cp312-macosx_14_0_arm64.whl
```
