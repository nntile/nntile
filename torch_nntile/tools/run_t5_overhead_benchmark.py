#!/usr/bin/env python3
"""Run T5 HF overhead ladder and emit parsed JSON results.
...
TRAIN = REPO / "torch_nntile" / "examples" / "train_t5_hf_overhead.py"
CONFIG_DIR = REPO / "torch_nntile" / "examples" / "overhead_t5"
