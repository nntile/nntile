#!/usr/bin/env python3
"""Run RoBERTa HF overhead ladder and emit parsed JSON results.
...
TRAIN = REPO / "torch_nntile" / "examples" / "train_roberta_hf_overhead.py"
CONFIG_DIR = REPO / "torch_nntile" / "examples" / "overhead_roberta"
